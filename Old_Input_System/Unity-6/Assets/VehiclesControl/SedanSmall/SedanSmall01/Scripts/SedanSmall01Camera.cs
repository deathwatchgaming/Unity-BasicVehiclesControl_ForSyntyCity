/*
 * File: SedanSmall 01 Camera
 * Name: SedanSmall01Camera.cs
...
namespace VehiclesControl
{
	// public class SedanSmall01Camera
	public class SedanSmall01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanSmall01.position.y plus _height
			float _desiredHeight = _sedanSmall01.position.y + _height;
			...
			// transform position is _sedanSmall01.position
			transform.position = _sedanSmall01.position;
			...
			// transform LookAt _sedanSmall01
			transform.LookAt(_sedanSmall01);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanSmall01.InverseTransformDirection(_sedanSmall01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanSmall01.eulerAngles.y plus 180
				_tempVector3.y = _sedanSmall01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanSmall01.eulerAngles.y
				_tempVector3.y = _sedanSmall01.eulerAngles.y;
			...
			float _autoCamControl = _sedanSmall01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanSmall01Camera
