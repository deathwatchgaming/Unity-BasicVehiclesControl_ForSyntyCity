...
namespace VehiclesControl
{
	// public class Taxi03Camera
	public class Taxi03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _taxi03.position.y plus _height
			float _desiredHeight = _taxi03.position.y + _height;
			...
			// transform position is _taxi03.position
			transform.position = _taxi03.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _taxi03.InverseTransformDirection(_taxi03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _taxi03.eulerAngles.y plus 180
				_tempVector3.y = _taxi03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _taxi03.eulerAngles.y
				_tempVector3.y = _taxi03.eulerAngles.y;
			...
			float _autoCamControl = _taxi03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Taxi03Camera
