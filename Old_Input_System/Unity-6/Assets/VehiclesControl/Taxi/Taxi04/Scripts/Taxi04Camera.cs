...
namespace VehiclesControl
{
	...
	public class Taxi04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _taxi04.InverseTransformDirection(_taxi04.GetComponent<Rigidbody>().linearVelocity);
			...
			float _autoCamControl = _taxi04.GetComponent<Rigidbody>().linearVelocity.magnitude;
