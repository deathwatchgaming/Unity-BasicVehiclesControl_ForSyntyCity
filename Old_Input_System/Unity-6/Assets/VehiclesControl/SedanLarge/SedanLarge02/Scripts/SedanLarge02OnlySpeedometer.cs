/*
 * File: SedanLarge 02 Only Speedometer
 * Name: SedanLarge02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanLarge02OnlySpeedUnit
	public enum SedanLarge02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanLarge02OnlySpeedUnit

	// public class SedanLarge02OnlySpeedometer 
	public class SedanLarge02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanLarge02OnlySpeedUnit _speedUnit	
			[SerializeField] private SedanLarge02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanLarge02OnlySpeedUnit.mph
			if (_speedUnit == SedanLarge02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanLarge02OnlySpeedUnit.mph
	...
	} // close public class SedanLarge02OnlySpeedometer
