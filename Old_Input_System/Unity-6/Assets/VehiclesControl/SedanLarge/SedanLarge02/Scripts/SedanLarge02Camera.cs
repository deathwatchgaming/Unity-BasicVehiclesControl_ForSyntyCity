/*
 * File: SedanLarge 02 Camera
 * Name: SedanLarge02Camera.cs
...
namespace VehiclesControl
{
	// public class SedanLarge02Camera
	public class SedanLarge02Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanLarge02.position.y plus _height
			float _desiredHeight = _sedanLarge02.position.y + _height;
			...
			// transform position is _sedanLarge02.position
			transform.position = _sedanLarge02.position;
			...
			// transform LookAt _sedanLarge02
			transform.LookAt(_sedanLarge02);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanLarge02.InverseTransformDirection(_sedanLarge02.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanLarge02.eulerAngles.y plus 180
				_tempVector3.y = _sedanLarge02.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanLarge02.eulerAngles.y
				_tempVector3.y = _sedanLarge02.eulerAngles.y;
			...
			float _autoCamControl = _sedanLarge02.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanLarge02Camera
