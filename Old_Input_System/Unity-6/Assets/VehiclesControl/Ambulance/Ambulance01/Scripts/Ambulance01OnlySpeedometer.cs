/*
 * File: Ambulance 01 Only Speedometer
 * Name: Ambulance01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Ambulance01OnlySpeedUnit
	public enum Ambulance01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Ambulance01OnlySpeedUnit

	// public class Ambulance01OnlySpeedometer 
	public class Ambulance01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Ambulance01OnlySpeedUnit _speedUnit	
			[SerializeField] private Ambulance01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Ambulance01OnlySpeedUnit.mph
			if (_speedUnit == Ambulance01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Ambulance01OnlySpeedUnit.mph
	...
	} // close public class Ambulance01OnlySpeedometer
