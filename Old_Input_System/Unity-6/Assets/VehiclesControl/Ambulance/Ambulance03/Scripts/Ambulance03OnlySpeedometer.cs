/*
 * File: Ambulance 03 Only Speedometer
 * Name: Ambulance03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Ambulance03OnlySpeedUnit
	public enum Ambulance03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Ambulance03OnlySpeedUnit

	// public class Ambulance03OnlySpeedometer 
	public class Ambulance03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Ambulance03OnlySpeedUnit _speedUnit	
			[SerializeField] private Ambulance03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Ambulance03OnlySpeedUnit.mph
			if (_speedUnit == Ambulance03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Ambulance03OnlySpeedUnit.mph
	...
	} // close public class Ambulance03OnlySpeedometer
