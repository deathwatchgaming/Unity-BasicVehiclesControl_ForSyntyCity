/*
 * File: Ambulance 03 Camera
 * Name: Ambulance03Camera.cs
...
namespace VehiclesControl
{
	// public class Ambulance03Camera
	public class Ambulance03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _ambulance03.position.y plus _height
			float _desiredHeight = _ambulance03.position.y + _height;
			...
			// transform position is _ambulance03.position
			transform.position = _ambulance03.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _ambulance03.InverseTransformDirection(_ambulance03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _ambulance03.eulerAngles.y plus 180
				_tempVector3.y = _ambulance03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _ambulance03.eulerAngles.y
				_tempVector3.y = _ambulance03.eulerAngles.y;
			...
			float _autoCamControl = _ambulance03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Ambulance03Camera
