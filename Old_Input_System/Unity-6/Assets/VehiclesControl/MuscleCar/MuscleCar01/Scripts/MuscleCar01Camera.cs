/*
 * File: MuscleCar 01 Camera
 * Name: MuscleCar01Camera.cs
...
namespace VehiclesControl
{
	// public class MuscleCar01Camera
	public class MuscleCar01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _muscleCar01.position.y plus _height
			float _desiredHeight = _muscleCar01.position.y + _height;
			...
			// transform position is _muscleCar01.position
			transform.position = _muscleCar01.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _muscleCar01.InverseTransformDirection(_muscleCar01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _muscleCar01.eulerAngles.y plus 180
				_tempVector3.y = _muscleCar01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _muscleCar01.eulerAngles.y
				_tempVector3.y = _muscleCar01.eulerAngles.y;
			...
			float _autoCamControl = _muscleCar01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class MuscleCar01Camera
