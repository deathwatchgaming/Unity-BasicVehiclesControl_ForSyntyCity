/*
 * File: MuscleCar 04 Camera
 * Name: MuscleCar04Camera.cs
...
namespace VehiclesControl
{
	// public class MuscleCar04Camera
	public class MuscleCar04Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _muscleCar04.position.y plus _height
			float _desiredHeight = _muscleCar04.position.y + _height;
			...
			// transform position is _muscleCar04.position
			transform.position = _muscleCar04.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _muscleCar04.InverseTransformDirection(_muscleCar04.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _muscleCar04.eulerAngles.y plus 180
				_tempVector3.y = _muscleCar04.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _muscleCar04.eulerAngles.y
				_tempVector3.y = _muscleCar04.eulerAngles.y;
			...
			float _autoCamControl = _muscleCar04.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class MuscleCar04Camera
