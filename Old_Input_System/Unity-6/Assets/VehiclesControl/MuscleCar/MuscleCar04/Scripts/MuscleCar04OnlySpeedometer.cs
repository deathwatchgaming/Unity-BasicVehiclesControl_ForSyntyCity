/*
 * File: MuscleCar 04 Only Speedometer
 * Name: MuscleCar04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum MuscleCar04OnlySpeedUnit
	public enum MuscleCar04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum MuscleCar04OnlySpeedUnit

	// public class MuscleCar04OnlySpeedometer 
	public class MuscleCar04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// MuscleCar04OnlySpeedUnit _speedUnit	
			[SerializeField] private MuscleCar04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals MuscleCar04OnlySpeedUnit.mph
			if (_speedUnit == MuscleCar04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals MuscleCar04OnlySpeedUnit.mph
	...
	} // close public class MuscleCar04OnlySpeedometer
