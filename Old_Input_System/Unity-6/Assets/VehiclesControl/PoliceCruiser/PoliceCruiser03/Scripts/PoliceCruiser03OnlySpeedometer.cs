/*
 * File: PoliceCruiser03 Only Speedometer
 * Name: PoliceCruiser03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum PoliceCruiser03OnlySpeedUnit
	public enum PoliceCruiser03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser03OnlySpeedUnit

	// public class PoliceCruiser03OnlySpeedometer 
	public class PoliceCruiser03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// PoliceCruiser03OnlySpeedUnit _speedUnit	
			[SerializeField] private PoliceCruiser03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals PoliceCruiser03OnlySpeedUnit.mph
			if (_speedUnit == PoliceCruiser03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals PoliceCruiser03OnlySpeedUnit.mph
	...
	} // close public class PoliceCruiser03OnlySpeedometer
