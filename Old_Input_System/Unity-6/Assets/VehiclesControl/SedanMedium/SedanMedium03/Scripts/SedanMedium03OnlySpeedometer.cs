/*
 * File: SedanMedium 03 Only Speedometer
 * Name: SedanMedium03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanMedium03OnlySpeedUnit
	public enum SedanMedium03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanMedium03OnlySpeedUnit

	// public class SedanMedium03OnlySpeedometer 
	public class SedanMedium03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanMedium03OnlySpeedUnit _speedUnit	
			[SerializeField] private SedanMedium03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanMedium03OnlySpeedUnit.mph
			if (_speedUnit == SedanMedium03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanMedium03OnlySpeedUnit.mph
	...
	} // close public class SedanMedium03OnlySpeedometer
