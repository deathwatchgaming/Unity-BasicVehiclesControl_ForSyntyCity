/*
 * File: SedanMedium 04 Camera
 * Name: SedanMedium04Camera.cs
...
namespace VehiclesControl
{
	// public class SedanMedium04Camera
	public class SedanMedium04Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanMedium04.position.y plus _height
			float _desiredHeight = _sedanMedium04.position.y + _height;
			...
			// transform position is _sedanMedium04.position
			transform.position = _sedanMedium04.position;
			...
			// transform LookAt _sedanMedium04
			transform.LookAt(_sedanMedium04);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanMedium04.InverseTransformDirection(_sedanMedium04.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanMedium04.eulerAngles.y plus 180
				_tempVector3.y = _sedanMedium04.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanMedium04.eulerAngles.y
				_tempVector3.y = _sedanMedium04.eulerAngles.y;
			...
			float _autoCamControl = _sedanMedium04.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanMedium04Camera
