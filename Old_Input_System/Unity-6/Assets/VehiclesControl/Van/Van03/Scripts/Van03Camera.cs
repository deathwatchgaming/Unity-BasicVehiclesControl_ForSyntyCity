...
namespace VehiclesControl
{
	// public class Van03Camera
	public class Van03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _van03.position.y plus _height
			float _desiredHeight = _van03.position.y + _height;
			...
			// transform position is _van03.position
			transform.position = _van03.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _van03.InverseTransformDirection(_van03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _van03.eulerAngles.y plus 180
				_tempVector3.y = _van03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _van03.eulerAngles.y
				_tempVector3.y = _van03.eulerAngles.y;
			...
			float _autoCamControl = _van03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Van03Camera
