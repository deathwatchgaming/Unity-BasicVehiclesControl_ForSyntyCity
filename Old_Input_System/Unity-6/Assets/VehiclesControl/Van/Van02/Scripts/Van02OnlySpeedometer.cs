/*
 * File: Van 02 Only Speedometer
 * Name: Van02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Van02OnlySpeedUnit
	public enum Van02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Van02OnlySpeedUnit

	// public class Van02OnlySpeedometer 
	public class Van02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Van02OnlySpeedUnit _speedUnit	
			[SerializeField] private Van02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Van02OnlySpeedUnit.mph
			if (_speedUnit == Van02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Van02OnlySpeedUnit.mph
	...
	} // close public class Van02OnlySpeedometer
