...
namespace VehiclesControl
{
	...
	public class SedanSmall01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanSmall01.InverseTransformDirection(_sedanSmall01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanSmall01.GetComponent<Rigidbody>().velocity.magnitude;
