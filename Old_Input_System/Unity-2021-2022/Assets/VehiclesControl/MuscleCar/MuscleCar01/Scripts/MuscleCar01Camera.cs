...
namespace VehiclesControl
{
	...
	public class MuscleCar01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _muscleCar01.InverseTransformDirection(_muscleCar01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _muscleCar01.GetComponent<Rigidbody>().velocity.magnitude;
