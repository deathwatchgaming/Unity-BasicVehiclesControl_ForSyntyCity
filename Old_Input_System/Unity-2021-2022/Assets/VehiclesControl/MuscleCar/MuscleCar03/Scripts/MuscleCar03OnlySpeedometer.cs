/*
 * File: MuscleCar 03 Only Speedometer
 * Name: MuscleCar03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum MuscleCar03OnlySpeedUnit
	public enum MuscleCar03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum MuscleCar03OnlySpeedUnit

	// public class MuscleCar03OnlySpeedometer 
	public class MuscleCar03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// MuscleCar03OnlySpeedUnit _speedUnit	
			[SerializeField] private MuscleCar03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals MuscleCar03OnlySpeedUnit.mph
			if (_speedUnit == MuscleCar03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals MuscleCar03OnlySpeedUnit.mph
	...
	} // close public class MuscleCar03OnlySpeedometer
