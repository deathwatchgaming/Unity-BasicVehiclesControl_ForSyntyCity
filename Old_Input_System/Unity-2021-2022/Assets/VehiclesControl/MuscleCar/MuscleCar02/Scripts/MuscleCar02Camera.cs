...
namespace VehiclesControl
{
	...
	public class MuscleCar02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _muscleCar02.InverseTransformDirection(_muscleCar02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _muscleCar02.GetComponent<Rigidbody>().velocity.magnitude;
