/*
 * File: Van 04 Only Speedometer
 * Name: Van04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Van04OnlySpeedUnit
	public enum Van04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Van04OnlySpeedUnit

	// public class Van04OnlySpeedometer 
	public class Van04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Van04OnlySpeedUnit _speedUnit	
			[SerializeField] private Van04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Van04OnlySpeedUnit.mph
			if (_speedUnit == Van04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Van04OnlySpeedUnit.mph
	...
	} // close public class Van04OnlySpeedometer
