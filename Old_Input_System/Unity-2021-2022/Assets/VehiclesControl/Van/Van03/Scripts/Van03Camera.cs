...
namespace VehiclesControl
{
	...
	public class Van03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _van03.InverseTransformDirection(_van03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _van03.GetComponent<Rigidbody>().velocity.magnitude;
