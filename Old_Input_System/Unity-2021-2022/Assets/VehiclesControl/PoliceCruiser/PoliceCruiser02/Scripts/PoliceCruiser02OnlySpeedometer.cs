/*
 * File: PoliceCruiser02 Only Speedometer
 * Name: PoliceCruiser02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum PoliceCruiser02OnlySpeedUnit
	public enum PoliceCruiser02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser02OnlySpeedUnit

	// public class PoliceCruiser02OnlySpeedometer 
	public class PoliceCruiser02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// PoliceCruiser02OnlySpeedUnit _speedUnit	
			[SerializeField] private PoliceCruiser02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals PoliceCruiser02OnlySpeedUnit.mph
			if (_speedUnit == PoliceCruiser02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals PoliceCruiser02OnlySpeedUnit.mph
	...
	} // close public class PoliceCruiser02OnlySpeedometer
