...
namespace VehiclesControl
{
	...
	public class Ambulance03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _ambulance03.InverseTransformDirection(_ambulance03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _ambulance03.GetComponent<Rigidbody>().velocity.magnitude;
