/*
 * File: SedanLarge 04 Only Speedometer
 * Name: SedanLarge04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanLarge04OnlySpeedUnit
	public enum SedanLarge04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanLarge04OnlySpeedUnit

	// public class SedanLarge04OnlySpeedometer 
	public class SedanLarge04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanLarge04OnlySpeedUnit _speedUnit	
			[SerializeField] private SedanLarge04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanLarge04OnlySpeedUnit.mph
			if (_speedUnit == SedanLarge04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanLarge04OnlySpeedUnit.mph
	...
	} // close public class SedanLarge04OnlySpeedometer
