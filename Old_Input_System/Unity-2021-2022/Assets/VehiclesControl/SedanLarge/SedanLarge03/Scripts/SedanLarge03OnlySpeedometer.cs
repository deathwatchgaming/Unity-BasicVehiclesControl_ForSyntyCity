/*
 * File: SedanLarge 03 Only Speedometer
 * Name: SedanLarge03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanLarge03OnlySpeedUnit
	public enum SedanLarge03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanLarge03OnlySpeedUnit

	// public class SedanLarge03OnlySpeedometer 
	public class SedanLarge03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanLarge03OnlySpeedUnit _speedUnit	
			[SerializeField] private SedanLarge03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanLarge03OnlySpeedUnit.mph
			if (_speedUnit == SedanLarge03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanLarge03OnlySpeedUnit.mph
	...
	} // close public class SedanLarge03OnlySpeedometer
