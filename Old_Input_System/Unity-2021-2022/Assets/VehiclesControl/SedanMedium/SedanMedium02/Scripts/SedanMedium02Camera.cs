...
namespace VehiclesControl
{
	...
	public class SedanMedium02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanMedium02.InverseTransformDirection(_sedanMedium02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanMedium02.GetComponent<Rigidbody>().velocity.magnitude;
