/*
 * File: MuscleCar 03 Speedometer (New Input System)
 * Name: MuscleCar03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum MuscleCar03SpeedUnit
	public enum MuscleCar03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum MuscleCar03SpeedUnit

	// public class MuscleCar03Speedometer 
	public class MuscleCar03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// MuscleCar03SpeedUnit _speedUnit	
			[SerializeField] private MuscleCar03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject_interfaceIMG01Object is FindInActiveObjectByName MuscleCar03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("MuscleCar03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName MuscleCar03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("MuscleCar03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName MuscleCar03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("MuscleCar03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName MuscleCar03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("MuscleCar03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals MuscleCar03SpeedUnit.mph
			if (_speedUnit == MuscleCar03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals MuscleCar03SpeedUnit.mph
	...
	} // close public class MuscleCar03Speedometer
