/*
 * File: MuscleCar 03 Camera
 * Name: MuscleCar03Camera.cs
...
namespace VehiclesControl
{
	// public class MuscleCar03Camera
	public class MuscleCar03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _muscleCar03.position.y plus _height
			float _desiredHeight = _muscleCar03.position.y + _height;
			...
			// transform position is _muscleCar03.position
			transform.position = _muscleCar03.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _muscleCar03.InverseTransformDirection(_muscleCar03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _muscleCar03.eulerAngles.y plus 180
				_tempVector3.y = _muscleCar03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _muscleCar03.eulerAngles.y
				_tempVector3.y = _muscleCar03.eulerAngles.y;
			...
			float _autoCamControl = _muscleCar03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class MuscleCar03Camera
