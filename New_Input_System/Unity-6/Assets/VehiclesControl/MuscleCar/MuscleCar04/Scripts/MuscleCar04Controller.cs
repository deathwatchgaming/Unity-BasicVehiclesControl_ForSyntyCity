/*
 * File: MuscleCar 04 Controller (New Input System)
 * Name: MuscleCar04Controller.cs
...
// Front Wheel Collider Position Y: 0.5011474 (0.3511474+0.15)
// Rear Wheel Collider Radius: 0.405789
// Rear Wheel Collider Position Y: 0.555789 (0.405789+0.15)
...
namespace VehiclesControl
{
	// public enum MuscleCar04SpeedType
	public enum MuscleCar04SpeedType
	{
		mph,
		kmh	

	} // close public enum MuscleCar04SpeedType
	...
	// public class MuscleCar04Controller
	public class MuscleCar04Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// MuscleCar04SpeedType _speedType	
			[SerializeField] private MuscleCar04SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the muscleCar04 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals MuscleCar04SpeedType.mph
			if (_speedType == MuscleCar04SpeedType.mph)
			{
			...
			} // close if _speedType equals MuscleCar04SpeedType.mph

			// else if _speedType equals MuscleCar04SpeedType.kmh
			else if (_speedType == MuscleCar04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals MuscleCar04SpeedType.kmh
	...
	} // close public class MuscleCar04Controller
