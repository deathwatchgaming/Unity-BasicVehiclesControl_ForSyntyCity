/*
 * File: MuscleCar 02 Controller (New Input System)
 * Name: MuscleCar02Controller.cs
...
namespace VehiclesControl
{
	// public enum MuscleCar02SpeedType
	public enum MuscleCar02SpeedType
	{
		mph,
		kmh	

	} // close public enum MuscleCar02SpeedType
	...
	// public class MuscleCar02Controller
	public class MuscleCar02Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// MuscleCar02SpeedType _speedType	
			[SerializeField] private MuscleCar02SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the muscleCar02 car from rolling
		...
		private void HandleSpeed()
		{
			...
			} // close if _speedType equals MuscleCar02SpeedType.mph

			// else if _speedType equals MuscleCar02SpeedType.kmh
			else if (_speedType == MuscleCar02SpeedType.kmh)
			{
			...
			} // close else if _speedType equals MuscleCar02SpeedType.kmh
	...
	} // close public class MuscleCar02Controller
