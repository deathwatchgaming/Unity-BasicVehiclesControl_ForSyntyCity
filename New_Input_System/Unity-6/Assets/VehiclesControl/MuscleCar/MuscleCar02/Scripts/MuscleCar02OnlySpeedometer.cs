/*
 * File: MuscleCar 02 Only Speedometer
 * Name: MuscleCar02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum MuscleCar02OnlySpeedUnit
	public enum MuscleCar02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum MuscleCar02OnlySpeedUnit

	// public class MuscleCar02OnlySpeedometer 
	public class MuscleCar02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// MuscleCar02OnlySpeedUnit _speedUnit	
			[SerializeField] private MuscleCar02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals MuscleCar02OnlySpeedUnit.mph
			if (_speedUnit == MuscleCar02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals MuscleCar02OnlySpeedUnit.mph
	...
	} // close public class MuscleCar02OnlySpeedometer
