/*
 * File: SedanMedium 02 Controller (New Input System)
 * Name: SedanMedium02Controller.cs
...
namespace VehiclesControl
{
	// public enum SedanMedium02SpeedType
	public enum SedanMedium02SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanMedium02SpeedType
	...
	// public class SedanMedium02Controller
	public class SedanMedium02Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// SedanMedium02SpeedType _speedType	
			[SerializeField] private SedanMedium02SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanMedium02SpeedType.mph
			if (_speedType == SedanMedium02SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanMedium02SpeedType.mph

			// else if _speedType equals SedanMedium02SpeedType.kmh
			else if (_speedType == SedanMedium02SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanMedium02SpeedType.kmh
	...
	} // close public class SedanMedium02Controller
