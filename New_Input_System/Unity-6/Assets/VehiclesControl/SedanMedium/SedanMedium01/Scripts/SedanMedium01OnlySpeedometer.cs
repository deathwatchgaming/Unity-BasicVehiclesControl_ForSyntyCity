/*
 * File: SedanMedium 01 Only Speedometer
 * Name: SedanMedium01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanMedium01OnlySpeedUnit
	public enum SedanMedium01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanMedium01OnlySpeedUnit

	// public class SedanMedium01OnlySpeedometer 
	public class SedanMedium01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanMedium01OnlySpeedUnit _speedUnit	
			[SerializeField] private SedanMedium01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanMedium01OnlySpeedUnit.mph
			if (_speedUnit == SedanMedium01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanMedium01OnlySpeedUnit.mph
	...
	} // close public class SedanMedium01OnlySpeedometer
