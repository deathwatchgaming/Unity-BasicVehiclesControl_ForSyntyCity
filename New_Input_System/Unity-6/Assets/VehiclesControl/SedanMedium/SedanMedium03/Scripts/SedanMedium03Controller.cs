/*
 * File: SedanMedium 03 Controller (New Input System)
 * Name: SedanMedium03Controller.cs
...
namespace VehiclesControl
{
	// public enum SedanMedium03SpeedType
	public enum SedanMedium03SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanMedium03SpeedType
	...
	// public class SedanMedium03Controller
	public class SedanMedium03Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// SedanMedium03SpeedType _speedType	
			[SerializeField] private SedanMedium03SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanMedium03 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanMedium03SpeedType.mph
			if (_speedType == SedanMedium03SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanMedium03SpeedType.mph

			// else if _speedType equals SedanMedium03SpeedType.kmh
			else if (_speedType == SedanMedium03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanMedium03SpeedType.kmh
	...
	} // close public class SedanMedium03Controller
