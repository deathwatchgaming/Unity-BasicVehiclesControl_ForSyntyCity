/*
 * File: SedanMedium 03 Speedometer (New Input System)
 * Name: SedanMedium03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanMedium03SpeedUnit
	public enum SedanMedium03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanMedium03SpeedUnit

	// public class SedanMedium03Speedometer 
	public class SedanMedium03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanMedium03SpeedUnit _speedUnit	
			[SerializeField] private SedanMedium03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanMedium03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanMedium03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanMedium03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanMedium03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanMedium03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanMedium03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanMedium03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanMedium03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SedanMedium03SpeedUnit.mph
			if (_speedUnit == SedanMedium03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanMedium03SpeedUnit.mph
			...
			if (_inSedanMedium03 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSedanMedium03 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class SedanMedium03Speedometer
