/*
 * File: SedanMedium 03 Camera
 * Name: SedanMedium03Camera.cs
...
namespace VehiclesControl
{
	// public class SedanMedium03Camera
	public class SedanMedium03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanMedium03.position.y plus _height
			float _desiredHeight = _sedanMedium03.position.y + _height;
			...
			// transform position is _sedanMedium03.position
			transform.position = _sedanMedium03.position;
			...
			// transform LookAt _sedanMedium03
			transform.LookAt(_sedanMedium03);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanMedium03.InverseTransformDirection(_sedanMedium03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanMedium03.eulerAngles.y plus 180
				_tempVector3.y = _sedanMedium03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanMedium03.eulerAngles.y
				_tempVector3.y = _sedanMedium03.eulerAngles.y;
			...
			float _autoCamControl = _sedanMedium03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanMedium03Camera
