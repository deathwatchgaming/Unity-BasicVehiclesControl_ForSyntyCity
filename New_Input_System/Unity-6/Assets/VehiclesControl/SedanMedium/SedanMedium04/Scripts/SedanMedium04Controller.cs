/*
 * File: SedanMedium 04 Controller (New Input System)
 * Name: SedanMedium04Controller.cs
...
// Wheel Collider Position Y: 0.5686304 (0.4186304+0.15)
...
namespace VehiclesControl
{
	// public enum SedanMedium04SpeedType
	public enum SedanMedium04SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanMedium04SpeedType
	...
	// public class SedanMedium04Controller
	public class SedanMedium04Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// SedanMedium04SpeedType _speedType	
			[SerializeField] private SedanMedium04SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanMedium04 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanMedium04SpeedType.mph
			if (_speedType == SedanMedium04SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanMedium04SpeedType.mph

			// else if _speedType equals SedanMedium04SpeedType.kmh
			else if (_speedType == SedanMedium04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanMedium04SpeedType.kmh
	...
	} // close public class SedanMedium04Controller
