/*
 * File: Ambulance 03 Speedometer (New Input System)
 * Name: Ambulance03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Ambulance03SpeedUnit
	public enum Ambulance03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Ambulance03SpeedUnit

	// public class Ambulance03Speedometer 
	public class Ambulance03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Ambulance03SpeedUnit _speedUnit	
			[SerializeField] private Ambulance03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Ambulance03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Ambulance03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Ambulance03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Ambulance03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Ambulance03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Ambulance03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Ambulance03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Ambulance03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Ambulance03SpeedUnit.mph
			if (_speedUnit == Ambulance03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Ambulance03SpeedUnit.mph
	...
	} // close public class Ambulance03Speedometer
