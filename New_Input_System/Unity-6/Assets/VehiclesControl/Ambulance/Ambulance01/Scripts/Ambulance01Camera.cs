/*
 * File: Ambulance 01 Camera
 * Name: Ambulance01Camera.cs
...
namespace VehiclesControl
{
	// public class Ambulance01Camera
	public class Ambulance01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _ambulance01.position.y plus _height
			float _desiredHeight = _ambulance01.position.y + _height;
			...
			// transform position is _ambulance01.position
			transform.position = _ambulance01.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _ambulance01.InverseTransformDirection(_ambulance01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _ambulance01.eulerAngles.y plus 180
				_tempVector3.y = _ambulance01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _ambulance01.eulerAngles.y
				_tempVector3.y = _ambulance01.eulerAngles.y;
			...
			float _autoCamControl = _ambulance01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Ambulance01Camera
