/*
 * File: Ambulance 02 Speedometer (New Input System)
...
namespace VehiclesControl
{
	...
	public class Ambulance02Speedometer : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Ambulance02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Ambulance02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Ambulance02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Ambulance02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Ambulance02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Ambulance02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Ambulance02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Ambulance02Speedometer");
