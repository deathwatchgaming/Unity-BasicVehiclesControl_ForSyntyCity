/*
 * File: Ambulance 04 Controller (New Input System)
 * Name: Ambulance04Controller.cs
...
namespace VehiclesControl
{
	// public enum Ambulance04SpeedType
	public enum Ambulance04SpeedType
	{
		mph,
		kmh	

	} // close public enum Ambulance04SpeedType
	...
	// public class Ambulance04Controller
	public class Ambulance04Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// Ambulance04SpeedType _speedType	
			[SerializeField] private Ambulance04SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the ambulance04 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Ambulance04SpeedType.mph
			if (_speedType == Ambulance04SpeedType.mph)
			{
			...
			} // close if _speedType equals Ambulance04SpeedType.mph

			// else if _speedType equals Ambulance04SpeedType.kmh
			else if (_speedType == Ambulance04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Ambulance04SpeedType.kmh
	...
	} // close public class Ambulance04Controller
