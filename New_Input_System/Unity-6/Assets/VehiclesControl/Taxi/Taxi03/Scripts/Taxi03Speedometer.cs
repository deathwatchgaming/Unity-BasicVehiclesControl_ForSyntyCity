/*
 * File: Taxi 03 Speedometer (New Input System)
...
namespace VehiclesControl
{
	...
	public class Taxi03Speedometer : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Taxi03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Taxi03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Taxi03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Taxi03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Taxi03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Taxi03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Taxi03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Taxi03Speedometer");
