/*
 * File: Taxi 04 Speedometer (New Input System)
...
namespace VehiclesControl
{
    // public enum Taxi04SpeedUnit
	public enum Taxi04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Taxi04SpeedUnit

	// public class Taxi04Speedometer 
	public class Taxi04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Taxi04SpeedUnit _speedUnit	
			[SerializeField] private Taxi04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Taxi04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Taxi04_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Taxi04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Taxi04_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Taxi04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Taxi04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Taxi04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Taxi04Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Taxi04SpeedUnit.mph
			if (_speedUnit == Taxi04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Taxi04SpeedUnit.mph
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inTaxi04 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Taxi04Speedometer
