/*
 * File: Taxi 02 Speedometer (New Input System)
 * Name: Taxi02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Taxi02SpeedUnit
	public enum Taxi02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Taxi02SpeedUnit

	// public class Taxi02Speedometer 
	public class Taxi02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Taxi02SpeedUnit _speedUnit	
			[SerializeField] private Taxi02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Taxi02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Taxi02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Taxi02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Taxi02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Taxi02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Taxi02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Taxi02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Taxi02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Taxi02SpeedUnit.mph
			if (_speedUnit == Taxi02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Taxi02SpeedUnit.mph
	...
	} // close public class Taxi02Speedometer
