/*
 * File: SedanSmall 04 Controller (New Input System)
 * Name: SedanSmall04Controller.cs
...
namespace VehiclesControl
{
	// public enum SedanSmall04SpeedType
	public enum SedanSmall04SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanSmall04SpeedType
	...
	// public class SedanSmall04Controller
	public class SedanSmall04Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// SedanSmall04SpeedType _speedType	
			[SerializeField] private SedanSmall04SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanSmall04 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanSmall04SpeedType.mph
			if (_speedType == SedanSmall04SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanSmall04SpeedType.mph

			// else if _speedType equals SedanSmall04SpeedType.kmh
			else if (_speedType == SedanSmall04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanSmall04SpeedType.kmh
	...
	} // close public class SedanSmall04Controller
