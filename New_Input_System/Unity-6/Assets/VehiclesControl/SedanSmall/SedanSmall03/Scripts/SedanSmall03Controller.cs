/*
 * File: SedanSmall 03 Controller (New Input System)
 * Name: SedanSmall03Controller.cs
...
namespace VehiclesControl
{
	// public enum SedanSmall03SpeedType
	public enum SedanSmall03SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanSmall03SpeedType
	...
	// public class SedanSmall03Controller
	public class SedanSmall03Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// SedanSmall03SpeedType _speedType	
			[SerializeField] private SedanSmall03SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanSmall03 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanSmall03SpeedType.mph
			if (_speedType == SedanSmall03SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanSmall03SpeedType.mph

			// else if _speedType equals SedanSmall03SpeedType.kmh
			else if (_speedType == SedanSmall03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanSmall03SpeedType.kmh
	...
	} // close public class SedanSmall03Controller
