/*
 * File: SedanSmall 03 Speedometer (New Input System)
 * Name: SedanSmall03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanSmall03SpeedUnit
	public enum SedanSmall03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanSmall03SpeedUnit

	// public class SedanSmall03Speedometer 
	public class SedanSmall03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanSmall03SpeedUnit _speedUnit	
			[SerializeField] private SedanSmall03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanSmall03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanSmall03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanSmall03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanSmall03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanSmall03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanSmall03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanSmall03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanSmall03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SedanSmall03SpeedUnit.mph
			if (_speedUnit == SedanSmall03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanSmall03SpeedUnit.mph
	...
	} // close public class SedanSmall03Speedometer
