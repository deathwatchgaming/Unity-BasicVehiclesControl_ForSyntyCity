/*
 * File: SedanSmall 01 Speedometer (New Input System)
 * Name: SedanSmall01Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanSmall01SpeedUnit
	public enum SedanSmall01SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanSmall01SpeedUnit

	// public class SedanSmall01Speedometer 
	public class SedanSmall01Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanSmall01SpeedUnit _speedUnit	
			[SerializeField] private SedanSmall01SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanSmall01_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanSmall01_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanSmall01_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanSmall01_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanSmall01_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanSmall01_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanSmall01Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanSmall01Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SedanSmall01SpeedUnit.mph
			if (_speedUnit == SedanSmall01SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanSmall01SpeedUnit.mph
	...
	} // close public class SedanSmall01Speedometer
