/*
 * File: PoliceCruiser01 Only Speedometer
 * Name: PoliceCruiser01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum PoliceCruiser01OnlySpeedUnit
	public enum PoliceCruiser01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser01OnlySpeedUnit

	// public class PoliceCruiser01OnlySpeedometer 
	public class PoliceCruiser01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// PoliceCruiser01OnlySpeedUnit _speedUnit	
			[SerializeField] private PoliceCruiser01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals PoliceCruiser01OnlySpeedUnit.mph
			if (_speedUnit == PoliceCruiser01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals PoliceCruiser01OnlySpeedUnit.mph
	...
	} // close public class PoliceCruiser01OnlySpeedometer
