/*
 * File: Police Cruiser 02 Speedometer (New Input System)
 * Name: PoliceCruiser02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum PoliceCruiser02SpeedUnit
	public enum PoliceCruiser02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser02SpeedUnit

	// public class PoliceCruiser02Speedometer 
	public class PoliceCruiser02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// PoliceCruiser02SpeedUnit _speedUnit	
			[SerializeField] private PoliceCruiser02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName PoliceCruiser02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("PoliceCruiser02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName PoliceCruiser02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("PoliceCruiser02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName PoliceCruiser02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("PoliceCruiser02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName PoliceCruiser02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("PoliceCruiser02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals PoliceCruiser02SpeedUnit.mph
			if (_speedUnit == PoliceCruiser02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals PoliceCruiser02SpeedUnit.mph
	...
	} // close public class PoliceCruiser02Speedometer
