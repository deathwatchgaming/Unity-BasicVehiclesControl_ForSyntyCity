/*
 * File: Van 02 Controller (New Input System)
 * Name: Van02Controller.cs
...
namespace VehiclesControl
{
	// public enum Van02SpeedType
	public enum Van02SpeedType
	{
		mph,
		kmh	

	} // close public enum Van02SpeedType
	...
	// public class Van02Controller
	public class Van02Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// Van02SpeedType _speedType	
			[SerializeField] private Van02SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the Van02 from rolling
