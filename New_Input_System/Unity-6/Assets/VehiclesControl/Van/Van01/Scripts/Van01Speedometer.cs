/*
 * File: Van 01 Speedometer (New Input System)
 * Name: Van01Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Van01SpeedUnit
	public enum Van01SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Van01SpeedUnit

	// public class Van01Speedometer 
	public class Van01Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Van01SpeedUnit _speedUnit	
			[SerializeField] private Van01SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Van01_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Van01_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Van01_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Van01_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Van01_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Van01_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Van01Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Van01Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Van01SpeedUnit.mph
			if (_speedUnit == Van01SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Van01SpeedUnit.mph
	...
	} // close public class Van01Speedometer
