/*
 * File: SedanLarge 02 Speedometer (New Input System)
 * Name: SedanLarge02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanLarge02SpeedUnit
	public enum SedanLarge02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanLarge02SpeedUnit

	// public class SedanLarge02Speedometer 
	public class SedanLarge02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanLarge02SpeedUnit _speedUnit	
			[SerializeField] private SedanLarge02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanLarge02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanLarge02_SpeedoGuage");

			// GameObject _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanLarge02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanLarge02_SpeedoNeedle");

			// GameObject _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanLarge02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanLarge02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanLarge02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanLarge02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SedanLarge02SpeedUnit.mph
			if (_speedUnit == SedanLarge02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanLarge02SpeedUnit.mph
	...
	} // close public class SedanLarge02Speedometer
