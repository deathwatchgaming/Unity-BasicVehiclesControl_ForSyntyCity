/*
 * File: SedanLarge 04 Camera
 * Name: SedanLarge04Camera.cs
...
namespace VehiclesControl
{
	// public class SedanLarge04Camera
	public class SedanLarge04Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanLarge04.position.y plus _height
			float _desiredHeight = _sedanLarge04.position.y + _height;
			...
			// transform position is _sedanLarge04.position
			transform.position = _sedanLarge04.position;
			...
			// transform LookAt _sedanLarge04
			transform.LookAt(_sedanLarge04);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanLarge04.InverseTransformDirection(_sedanLarge04.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanLarge04.eulerAngles.y plus 180
				_tempVector3.y = _sedanLarge04.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanLarge04.eulerAngles.y
				_tempVector3.y = _sedanLarge04.eulerAngles.y;
			...
			float _autoCamControl = _sedanLarge04.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanLarge04Camera
