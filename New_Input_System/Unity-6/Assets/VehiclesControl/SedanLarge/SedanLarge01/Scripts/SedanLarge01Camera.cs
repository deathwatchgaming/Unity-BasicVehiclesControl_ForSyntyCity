/*
 * File: SedanLarge 01 Camera
 * Name: SedanLarge01Camera.cs
...
namespace VehiclesControl
{
	// public class SedanLarge01Camera
	public class SedanLarge01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanLarge01.position.y plus _height
			float _desiredHeight = _sedanLarge01.position.y + _height;
			...
			// transform position is _sedanLarge01.position
			transform.position = _sedanLarge01.position;
			...
			// transform LookAt _sedanLarge01
			transform.LookAt(_sedanLarge01);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanLarge01.InverseTransformDirection(_sedanLarge01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanLarge01.eulerAngles.y plus 180
				_tempVector3.y = _sedanLarge01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanLarge01.eulerAngles.y
				_tempVector3.y = _sedanLarge01.eulerAngles.y;
			...
			float _autoCamControl = _sedanLarge01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanLarge01Camera
