...
namespace VehiclesControl
{
	...
	public class SedanLarge04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanLarge04.InverseTransformDirection(_sedanLarge04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanLarge04.GetComponent<Rigidbody>().velocity.magnitude;
