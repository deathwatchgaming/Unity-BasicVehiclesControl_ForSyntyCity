...
namespace VehiclesControl
{
	...
	public class SedanLarge02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanLarge02.InverseTransformDirection(_sedanLarge02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanLarge02.GetComponent<Rigidbody>().velocity.magnitude;
