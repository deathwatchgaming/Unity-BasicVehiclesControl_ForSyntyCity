/*
 * File: SedanLarge 03 Speedometer (New Input System)
 * Name: SedanLarge03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanLarge03SpeedUnit
	public enum SedanLarge03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanLarge03SpeedUnit

	// public class SedanLarge03Speedometer 
	public class SedanLarge03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanLarge03SpeedUnit _speedUnit	
			[SerializeField] private SedanLarge03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanLarge03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanLarge03_SpeedoGuage");

			// GameObject _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanLarge03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanLarge03_SpeedoNeedle");

			// GameObject _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanLarge03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanLarge03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanLarge03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanLarge03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SedanLarge03SpeedUnit.mph
			if (_speedUnit == SedanLarge03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanLarge03SpeedUnit.mph
			...
			if (_inSedanLarge03 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSedanLarge03 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class SedanLarge03Speedometer
