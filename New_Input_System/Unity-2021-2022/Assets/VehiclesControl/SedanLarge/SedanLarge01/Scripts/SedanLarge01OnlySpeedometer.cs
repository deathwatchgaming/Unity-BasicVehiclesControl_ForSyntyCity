/*
 * File: SedanLarge 01 Only Speedometer
 * Name: SedanLarge01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanLarge01OnlySpeedUnit
	public enum SedanLarge01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanLarge01OnlySpeedUnit

	// public class SedanLarge01OnlySpeedometer 
	public class SedanLarge01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanLarge01OnlySpeedUnit _speedUnit	
			[SerializeField] private SedanLarge01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanLarge01OnlySpeedUnit.mph
			if (_speedUnit == SedanLarge01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanLarge01OnlySpeedUnit.mph
	...
	} // close public class SedanLarge01OnlySpeedometer
