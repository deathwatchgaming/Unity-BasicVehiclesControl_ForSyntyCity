...
namespace VehiclesControl
{
	...
	public class MuscleCar04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _muscleCar04.InverseTransformDirection(_muscleCar04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _muscleCar04.GetComponent<Rigidbody>().velocity.magnitude;
