/*
 * File: MuscleCar 02 Speedometer (New Input System)
 * Name: MuscleCar02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum MuscleCar02SpeedUnit
	public enum MuscleCar02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum MuscleCar02SpeedUnit

	// public class MuscleCar02Speedometer 
	public class MuscleCar02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// MuscleCar02SpeedUnit _speedUnit	
			[SerializeField] private MuscleCar02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject_interfaceIMG01Object is FindInActiveObjectByName MuscleCar02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("MuscleCar02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName MuscleCar02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("MuscleCar02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName MuscleCar02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("MuscleCar02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName MuscleCar02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("MuscleCar02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals MuscleCar02SpeedUnit.mph
			if (_speedUnit == MuscleCar02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals MuscleCar02SpeedUnit.mph
	...
	} // close public class MuscleCar02Speedometer
