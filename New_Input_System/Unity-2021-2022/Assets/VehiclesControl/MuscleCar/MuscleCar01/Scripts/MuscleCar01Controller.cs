/*
 * File: MuscleCar 01 Controller (New Input System)
...
namespace VehiclesControl
{
	// public enum MuscleCar01SpeedType
	public enum MuscleCar01SpeedType
	{
		mph,
		kmh	

	} // close public enum MuscleCar01SpeedType
	...
	// public class MuscleCar01Controller
	public class MuscleCar01Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// MuscleCar01SpeedType _speedType	
			[SerializeField] private MuscleCar01SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the muscleCar01 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals MuscleCar01SpeedType.mph
			if (_speedType == MuscleCar01SpeedType.mph)
			{
			...
			} // close if _speedType equals MuscleCar01SpeedType.mph

			// else if _speedType equals MuscleCar01SpeedType.kmh
			else if (_speedType == MuscleCar01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals MuscleCar01SpeedType.kmh
	...
	} // close public class MuscleCar01Controller
