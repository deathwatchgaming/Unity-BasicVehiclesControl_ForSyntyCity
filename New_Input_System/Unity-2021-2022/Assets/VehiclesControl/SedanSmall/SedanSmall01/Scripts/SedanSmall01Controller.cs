/*
 * File: SedanSmall 01 Controller (New Input System)
 * Name: SedanSmall01Controller.cs
...
namespace VehiclesControl
{
	// public enum SedanSmall01SpeedType
	public enum SedanSmall01SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanSmall01SpeedType
	...
	// public class SedanSmall01Controller
	public class SedanSmall01Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// SedanSmall01SpeedType _speedType	
			[SerializeField] private SedanSmall01SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanSmall01 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanSmall01SpeedType.mph
			if (_speedType == SedanSmall01SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanSmall01SpeedType.mph

			// else if _speedType equals SedanSmall01SpeedType.kmh
			else if (_speedType == SedanSmall01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanSmall01SpeedType.kmh
	...
	} // close public class SedanSmall01Controller
