...
namespace VehiclesControl
{
	...
	public class SedanSmall04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanSmall04.InverseTransformDirection(_sedanSmall04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanSmall04.GetComponent<Rigidbody>().velocity.magnitude;
