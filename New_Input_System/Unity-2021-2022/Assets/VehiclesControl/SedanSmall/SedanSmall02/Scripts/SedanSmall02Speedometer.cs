/*
 * File: SedanSmall 02 Speedometer (New Input System)
 * Name: SedanSmall02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanSmall02SpeedUnit
	public enum SedanSmall02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanSmall02SpeedUnit

	// public class SedanSmall02Speedometer 
	public class SedanSmall02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanSmall02SpeedUnit _speedUnit	
			[SerializeField] private SedanSmall02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanSmall02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanSmall02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanSmall02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanSmall02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanSmall02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanSmall02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanSmall02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanSmall02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SedanSmall02SpeedUnit.mph
			if (_speedUnit == SedanSmall02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanSmall02SpeedUnit.mph
	...
	} // close public class SedanSmall02Speedometer
