...
namespace VehiclesControl
{
	...
	public class SedanSmall02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanSmall02.InverseTransformDirection(_sedanSmall02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanSmall02.GetComponent<Rigidbody>().velocity.magnitude;
