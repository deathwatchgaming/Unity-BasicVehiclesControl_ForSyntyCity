...
namespace VehiclesControl
{
	...
	public class Taxi01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _taxi01.InverseTransformDirection(_taxi01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _taxi01.GetComponent<Rigidbody>().velocity.magnitude;
