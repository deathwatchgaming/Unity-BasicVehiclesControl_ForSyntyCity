/*
 * File: Taxi 01 Only Speedometer
 * Name: Taxi01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Taxi01OnlySpeedUnit
	public enum Taxi01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Taxi01OnlySpeedUnit

	// public class Taxi01OnlySpeedometer 
	public class Taxi01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Taxi01OnlySpeedUnit _speedUnit	
			[SerializeField] private Taxi01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Taxi01OnlySpeedUnit.mph
			if (_speedUnit == Taxi01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Taxi01OnlySpeedUnit.mph
	...
	} // close public class Taxi01OnlySpeedometer
