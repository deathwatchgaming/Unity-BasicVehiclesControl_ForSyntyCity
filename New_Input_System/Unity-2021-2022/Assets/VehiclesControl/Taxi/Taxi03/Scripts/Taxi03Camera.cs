...
namespace VehiclesControl
{
	...
	public class Taxi03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _taxi03.InverseTransformDirection(_taxi03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _taxi03.GetComponent<Rigidbody>().velocity.magnitude;
