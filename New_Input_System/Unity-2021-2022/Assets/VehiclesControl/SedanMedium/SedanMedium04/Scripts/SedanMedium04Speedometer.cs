/*
 * File: SedanMedium 04 Speedometer (New Input System)
 * Name: SedanMedium04Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanMedium04SpeedUnit
	public enum SedanMedium04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanMedium04SpeedUnit

	// public class SedanMedium04Speedometer 
	public class SedanMedium04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanMedium04SpeedUnit _speedUnit	
			[SerializeField] private SedanMedium04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanMedium04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanMedium04_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanMedium04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanMedium04_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanMedium04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanMedium04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanMedium04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanMedium04Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SedanMedium04SpeedUnit.mph
			if (_speedUnit == SedanMedium04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanMedium04SpeedUnit.mph
			...
			if (_inSedanMedium04 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSedanMedium04 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class SedanMedium04Speedometer
