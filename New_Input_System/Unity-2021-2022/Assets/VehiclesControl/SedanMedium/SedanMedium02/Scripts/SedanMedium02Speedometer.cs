/*
 * File: SedanMedium 02 Speedometer (New Input System)
 * Name: SedanMedium02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanMedium02SpeedUnit
	public enum SedanMedium02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanMedium02SpeedUnit

	// public class SedanMedium02Speedometer 
	public class SedanMedium02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanMedium02SpeedUnit _speedUnit	
			[SerializeField] private SedanMedium02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanMedium02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanMedium02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanMedium02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanMedium02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanMedium02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanMedium02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanMedium02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanMedium02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SedanMedium02SpeedUnit.mph
			if (_speedUnit == SedanMedium02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanMedium02SpeedUnit.mph
	...
	} // close public class SedanMedium02Speedometer
