/*
 * File: SedanMedium 01 Speedometer
 * Name: SedanMedium01Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanMedium01SpeedUnit
	public enum SedanMedium01SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanMedium01SpeedUnit

	// public class SedanMedium01Speedometer 
	public class SedanMedium01Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanMedium01SpeedUnit _speedUnit	
			[SerializeField] private SedanMedium01SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanMedium01_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanMedium01_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanMedium01_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanMedium01_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanMedium01_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanMedium01_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanMedium01Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanMedium01Speedometer");
		...
		private void Update()
		{
			// if _speedUnit equals SedanMedium01SpeedUnit.mph
			if (_speedUnit == SedanMedium01SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanMedium01SpeedUnit.mph
			...
			if (_inSedanMedium01 && Input.GetKey(_exitKey))
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSedanMedium01 && other.gameObject.tag == "Player" && Input.GetKey(_enterKey))
			{
	...
	} // close public class SedanMedium01Speedometer
