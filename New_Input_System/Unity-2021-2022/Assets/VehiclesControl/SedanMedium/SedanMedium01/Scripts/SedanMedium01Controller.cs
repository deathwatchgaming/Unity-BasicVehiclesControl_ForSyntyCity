/*
 * File: SedanMedium 01 Controller (New Input System)
...
namespace VehiclesControl
{
	// public enum SedanMedium01SpeedType
	public enum SedanMedium01SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanMedium01SpeedType
	...
	// public class SedanMedium01Controller
	public class SedanMedium01Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// SedanMedium01SpeedType _speedType	
			[SerializeField] private SedanMedium01SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanMedium01 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanMedium01SpeedType.mph
			if (_speedType == SedanMedium01SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanMedium01SpeedType.mph

			// else if _speedType equals SedanMedium01SpeedType.kmh
			else if (_speedType == SedanMedium01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanMedium01SpeedType.kmh
	...
	} // close public class SedanMedium01Controller
