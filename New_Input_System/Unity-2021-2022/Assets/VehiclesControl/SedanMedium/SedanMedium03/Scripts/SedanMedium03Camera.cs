...
namespace VehiclesControl
{
	...
	public class SedanMedium03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanMedium03.InverseTransformDirection(_sedanMedium03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanMedium03.GetComponent<Rigidbody>().velocity.magnitude;
