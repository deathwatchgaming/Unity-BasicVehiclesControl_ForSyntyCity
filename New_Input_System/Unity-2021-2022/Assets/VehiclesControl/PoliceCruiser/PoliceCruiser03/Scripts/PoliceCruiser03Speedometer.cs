/*
 * File: Police Cruiser 03 Speedometer (New Input System)
...
namespace VehiclesControl
{
	...
	public class PoliceCruiser03Speedometer : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName PoliceCruiser03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("PoliceCruiser03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName PoliceCruiser03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("PoliceCruiser03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName PoliceCruiser03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("PoliceCruiser03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName PoliceCruiser03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("PoliceCruiser03Speedometer");
		...
		private void Update()
		{
			...
			if (_inPoliceCruiser03 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inPoliceCruiser03 && other.gameObject.tag == "Player" && _enterButton == true)
			{
