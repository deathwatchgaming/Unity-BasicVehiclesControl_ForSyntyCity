...
namespace VehiclesControl
{
	...
	public class PoliceCruiser03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCruiser03.InverseTransformDirection(_policeCruiser03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _policeCruiser03.GetComponent<Rigidbody>().velocity.magnitude;
