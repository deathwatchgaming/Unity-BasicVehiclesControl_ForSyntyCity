/*
 * File: Police Cruiser 04 Speedometer (New Input System)
 * Name: PoliceCruiser04Speedometer.cs
...
namespace VehiclesControl
{
    // public enum PoliceCruiser04SpeedUnit
	public enum PoliceCruiser04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser04SpeedUnit

	// public class PoliceCruiser04Speedometer 
	public class PoliceCruiser04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// PoliceCruiser04SpeedUnit _speedUnit	
			[SerializeField] private PoliceCruiser04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName PoliceCruiser04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("PoliceCruiser04_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName PoliceCruiser04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("PoliceCruiser04_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName PoliceCruiser04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("PoliceCruiser04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName PoliceCruiser04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("PoliceCruiser04Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals PoliceCruiser04SpeedUnit.mph
			if (_speedUnit == PoliceCruiser04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals PoliceCruiser04SpeedUnit.mph
	...
	} // close public class PoliceCruiser04Speedometer
