...
namespace VehiclesControl
{
	...
	public class PoliceCruiser02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCruiser02.InverseTransformDirection(_policeCruiser02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _policeCruiser02.GetComponent<Rigidbody>().velocity.magnitude;
