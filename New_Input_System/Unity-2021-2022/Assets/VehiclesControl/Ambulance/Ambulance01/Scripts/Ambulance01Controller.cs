/*
 * File: Ambulance 01 Controller (New Input System)
 * Name: Ambulance01Controller.cs
...
namespace VehiclesControl
{
	// public enum Ambulance01SpeedType
	public enum Ambulance01SpeedType
	{
		mph,
		kmh	

	} // close public enum Ambulance01SpeedType
	...
	// public class Ambulance01Controller
	public class Ambulance01Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// Ambulance01SpeedType _speedType	
			[SerializeField] private Ambulance01SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the ambulance01 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Ambulance01SpeedType.mph
			if (_speedType == Ambulance01SpeedType.mph)
			{
			...
			} // close if _speedType equals Ambulance01SpeedType.mph

			// else if _speedType equals Ambulance01SpeedType.kmh
			else if (_speedType == Ambulance01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Ambulance01SpeedType.kmh
	...
	} // close public class Ambulance01Controller
