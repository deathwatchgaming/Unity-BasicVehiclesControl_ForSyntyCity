...
namespace VehiclesControl
{
	...
	public class Ambulance01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _ambulance01.InverseTransformDirection(_ambulance01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _ambulance01.GetComponent<Rigidbody>().velocity.magnitude;
