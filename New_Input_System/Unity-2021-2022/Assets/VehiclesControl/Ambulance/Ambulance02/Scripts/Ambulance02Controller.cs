/*
 * File: Ambulance 02 Controller (New Input System)
 * Name: Ambulance02Controller.cs
...
namespace VehiclesControl
{
	// public enum Ambulance02SpeedType
	public enum Ambulance02SpeedType
	{
		mph,
		kmh	

	} // close public enum Ambulance02SpeedType
	...
	// public class Ambulance02Controller
	public class Ambulance02Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// Ambulance02SpeedType _speedType	
			[SerializeField] private Ambulance02SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the ambulance02 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Ambulance02SpeedType.mph
			if (_speedType == Ambulance02SpeedType.mph)
			{
			...
			} // close if _speedType equals Ambulance02SpeedType.mph

			// else if _speedType equals Ambulance02SpeedType.kmh
			else if (_speedType == Ambulance02SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Ambulance02SpeedType.kmh
	...
	} // close public class Ambulance02Controller
