/*
 * File: Ambulance 03 Controller (New Input System)
 * Name: Ambulance03Controller.cs
...
namespace VehiclesControl
{
	// public enum Ambulance03SpeedType
	public enum Ambulance03SpeedType
	{
		mph,
		kmh	

	} // close public enum Ambulance03SpeedType
	...
	// public class Ambulance03Controller
	public class Ambulance03Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// Ambulance03SpeedType _speedType	
			[SerializeField] private Ambulance03SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Ambulance03SpeedType.mph
			if (_speedType == Ambulance03SpeedType.mph)
			{
			...
			} // close if _speedType equals Ambulance03SpeedType.mph

			// else if _speedType equals Ambulance03SpeedType.kmh
			else if (_speedType == Ambulance03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Ambulance03SpeedType.kmh
	...
	} // close public class Ambulance03Controller
