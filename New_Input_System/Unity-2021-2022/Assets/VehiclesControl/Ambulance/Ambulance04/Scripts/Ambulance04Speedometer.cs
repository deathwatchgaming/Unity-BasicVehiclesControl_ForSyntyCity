/*
 * File: Ambulance 04 Speedometer (New Input System)
 * Name: Ambulance04Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Ambulance04SpeedUnit
	public enum Ambulance04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Ambulance04SpeedUnit

	// public class Ambulance04Speedometer 
	public class Ambulance04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Ambulance04SpeedUnit _speedUnit	
			[SerializeField] private Ambulance04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Ambulance04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Ambulance04_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Ambulance04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Ambulance04_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Ambulance04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Ambulance04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Ambulance04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Ambulance04Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Ambulance04SpeedUnit.mph
			if (_speedUnit == Ambulance04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Ambulance04SpeedUnit.mph
	...
	} // close public class Ambulance04Speedometer
