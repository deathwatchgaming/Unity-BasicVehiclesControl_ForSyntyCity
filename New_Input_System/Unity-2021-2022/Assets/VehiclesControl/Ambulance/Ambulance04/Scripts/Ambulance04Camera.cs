...
namespace VehiclesControl
{
	...
	public class Ambulance04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _ambulance04.InverseTransformDirection(_ambulance04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _ambulance04.GetComponent<Rigidbody>().velocity.magnitude;
