/*
 * File: Van 03 Controller (New Input System)
 * Name: Van03Controller.cs
...
namespace VehiclesControl
{
	// public enum Van03SpeedType
	public enum Van03SpeedType
	{
		mph,
		kmh	

	} // close public enum Van03SpeedType
	...
	// public class Van03Controller
	public class Van03Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// Van03SpeedType _speedType	
			[SerializeField] private Van03SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the Van03 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Van03SpeedType.mph
			if (_speedType == Van03SpeedType.mph)
			{
			...
			} // close if _speedType equals Van03SpeedType.mph

			// else if _speedType equals Van03SpeedType.kmh
			else if (_speedType == Van03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Van03SpeedType.kmh
	...
	} // close public class Van03Controller
