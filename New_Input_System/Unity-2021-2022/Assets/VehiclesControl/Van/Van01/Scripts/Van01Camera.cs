...
namespace VehiclesControl
{
	...
	public class Van01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _van01.InverseTransformDirection(_van01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _van01.GetComponent<Rigidbody>().velocity.magnitude;
