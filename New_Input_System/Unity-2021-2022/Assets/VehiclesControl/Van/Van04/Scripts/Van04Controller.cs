/*
 * File: Van 04 Controller (New Input System)
 * Name: Van04Controller.cs
...
namespace VehiclesControl
{
	// public enum Van04SpeedType
	public enum Van04SpeedType
	{
		mph,
		kmh	

	} // close public enum Van04SpeedType
	...
	// public class Van04Controller
	public class Van04Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// Van04SpeedType _speedType	
			[SerializeField] private Van04SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the Van04 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Van04SpeedType.mph
			if (_speedType == Van04SpeedType.mph)
			{
			...
			} // close if _speedType equals Van04SpeedType.mph

			// else if _speedType equals Van04SpeedType.kmh
			else if (_speedType == Van04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Van04SpeedType.kmh
	...
	} // close public class Van04Controller
