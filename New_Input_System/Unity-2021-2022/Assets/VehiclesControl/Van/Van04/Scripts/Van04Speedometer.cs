/*
 * File: Van 04 Speedometer (New Input System)
 * Name: Van04Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Van04SpeedUnit
	public enum Van04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Van04SpeedUnit

	// public class Van04Speedometer 
	public class Van04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Van04SpeedUnit _speedUnit	
			[SerializeField] private Van04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Van04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Van04_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Van04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Van04_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Van04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Van04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Van04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Van04Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Van04SpeedUnit.mph
			if (_speedUnit == Van04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Van04SpeedUnit.mph
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inVan04 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Van04Speedometer
