...
namespace VehiclesControl
{
	...
	public class Van04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _van04.InverseTransformDirection(_van04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _van04.GetComponent<Rigidbody>().velocity.magnitude;
