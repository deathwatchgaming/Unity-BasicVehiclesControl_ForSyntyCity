/*
 * File: Van 02 Speedometer (New Input System)
 * Name: Van02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Van02SpeedUnit
	public enum Van02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Van02SpeedUnit

	// public class Van02Speedometer 
	public class Van02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Van02SpeedUnit _speedUnit	
			[SerializeField] private Van02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Van02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Van02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Van02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Van02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Van02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Van02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Van02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Van02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Van02SpeedUnit.mph
			if (_speedUnit == Van02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Van02SpeedUnit.mph
	...
	} // close public class Van02Speedometer
