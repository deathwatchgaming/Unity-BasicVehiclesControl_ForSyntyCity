...
namespace VehiclesControl
{
	// public class Van02Camera
	public class Van02Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _van02.position.y plus _height
			float _desiredHeight = _van02.position.y + _height;
			...
			// transform position is _van02.position
			transform.position = _van02.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _van02.InverseTransformDirection(_van02.GetComponent<Rigidbody>().velocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _van02.eulerAngles.y plus 180
				_tempVector3.y = _van02.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _van02.eulerAngles.y
				_tempVector3.y = _van02.eulerAngles.y;
			...
			float _autoCamControl = _van02.GetComponent<Rigidbody>().velocity.magnitude;
	...
	} // close public class Van02Camera
