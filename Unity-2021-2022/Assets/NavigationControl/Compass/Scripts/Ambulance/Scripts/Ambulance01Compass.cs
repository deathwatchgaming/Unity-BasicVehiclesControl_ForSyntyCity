/*
*  Name: Ambulance 01 Compass
*  File: Ambulance01Compass.cs
...
namespace NavigationControl
{
	// public class Ambulance01Compass
	public class Ambulance01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Ambulance01 transform")]
			// Transform _ambulance01
			[SerializeField] private Transform _ambulance01;
		...
		public static Ambulance01Compass _ambulance01Compass;

		// private void Start
		private void Start()
		{
			// _ambulance01Compass
			_ambulance01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Ambulance01Compass is enabled
				GetComponent<Ambulance01Compass>().enabled = true;

				// Debug Log Ambulance01 compass is enabled
			...
			{
				// Debug Log Ambulance01 compass is disabled
				...
				// Get Component Ambulance01Compass is not enabled
				GetComponent<Ambulance01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _ambulance01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_ambulance01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _ambulance01 forward vector

			// Vector3 forward is _ambulance01 transform forward
			Vector3 forward = _ambulance01.transform.forward;

			// Zero out the Y of _ambulance01 forward vector to only get the direction in the X,Z 
	...
	} // close public class Ambulance01Compass
