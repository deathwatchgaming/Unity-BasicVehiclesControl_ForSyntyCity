/*
*  Name: Ambulance 02 Compass
*  File: Ambulance02Compass.cs
...
namespace NavigationControl
{
	// public class Ambulance02Compass
	public class Ambulance02Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Ambulance02 transform")]
			// Transform _ambulance02
			[SerializeField] private Transform _ambulance02;
		...
		public static Ambulance02Compass _ambulance02Compass;

		// private void Start
		private void Start()
		{
			// _ambulance02Compass
			_ambulance02Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Ambulance02Compass is enabled
				GetComponent<Ambulance02Compass>().enabled = true;

				// Debug Log Ambulance02 compass is enabled
			...
			{
				// Debug Log Ambulance02 compass is disabled
				...
				// Get Component Ambulance02Compass is not enabled
				GetComponent<Ambulance02Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _ambulance02 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_ambulance02.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _ambulance02 forward vector

			// Vector3 forward is _ambulance02 transform forward
			Vector3 forward = _ambulance02.transform.forward;

			// Zero out the Y of _ambulance02 forward vector to only get the direction in the X,Z 
	...
	} // close public class Ambulance02Compass
