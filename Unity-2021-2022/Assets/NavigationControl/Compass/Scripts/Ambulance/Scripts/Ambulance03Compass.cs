/*
*  Name: Ambulance 03 Compass
*  File: Ambulance03Compass.cs
...
namespace NavigationControl
{
	// public class Ambulance03Compass
	public class Ambulance03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Ambulance03 transform")]
			// Transform _ambulance03
			[SerializeField] private Transform _ambulance03;
		...
		public static Ambulance03Compass _ambulance03Compass;

		// private void Start
		private void Start()
		{
			// _ambulance03Compass
			_ambulance03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Ambulance03Compass is enabled
				GetComponent<Ambulance03Compass>().enabled = true;

				// Debug Log Ambulance03 compass is enabled
			...
			{
				// Debug Log Ambulance03 compass is disabled
				...
				// Get Component Ambulance03Compass is not enabled
				GetComponent<Ambulance03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _ambulance03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_ambulance03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _ambulance03 forward vector

			// Vector3 forward is _ambulance03 transform forward
			Vector3 forward = _ambulance03.transform.forward;

			// Zero out the Y of _ambulance03 forward vector to only get the direction in the X,Z 
	...
	} // close public class Ambulance03Compass
