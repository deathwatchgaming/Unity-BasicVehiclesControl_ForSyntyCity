/*
*  Name: Muscle Car 03 Compass
*  File: MuscleCar03Compass.cs
...
namespace NavigationControl
{
	// public class MuscleCar03Compass
	public class MuscleCar03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The MuscleCar03 transform")]
			// Transform _muscleCar03
			[SerializeField] private Transform _muscleCar03;
		...
		public static MuscleCar03Compass _muscleCar03Compass;

		// private void Start
		private void Start()
		{
			// _muscleCar03Compass
			_muscleCar03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component MuscleCar03Compass is enabled
				GetComponent<MuscleCar03Compass>().enabled = true;

				// Debug Log MuscleCar03 compass is enabled
			...
			{
				// Debug Log MuscleCar03 compass is disabled
				...
				// Get Component MuscleCar03Compass is not enabled
				GetComponent<MuscleCar03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _muscleCar03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_muscleCar03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _muscleCar03 forward vector

			// Vector3 forward is _muscleCar03 transform forward
			Vector3 forward = _muscleCar03.transform.forward;

			// Zero out the Y of _muscleCar03 forward vector to only get the direction in the X,Z 
	...
	} // close public class MuscleCar03Compass
