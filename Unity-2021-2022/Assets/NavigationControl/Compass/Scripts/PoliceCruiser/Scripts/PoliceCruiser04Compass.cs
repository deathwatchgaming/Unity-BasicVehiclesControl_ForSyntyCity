/*
*  Name: Police Cruiser 04 Compass
*  File: PoliceCruiser04Compass.cs
...
namespace NavigationControl
{
	// public class PoliceCruiser04Compass
	public class PoliceCruiser04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The PoliceCruiser04 transform")]
			// Transform _policeCruiser04
			[SerializeField] private Transform _policeCruiser04;
		...
		// PoliceCruiser04Compass _cruiser04Compass
		public static PoliceCruiser04Compass _cruiser04Compass;

		// private void Start
		private void Start()
		{
			// _cruiser04Compass
			_cruiser04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component PoliceCruiser04Compass is enabled
				GetComponent<PoliceCruiser04Compass>().enabled = true;

				// Debug Log PoliceCruiser04 compass is enabled
				//Debug.Log("The PoliceCruiser04 compass is enabled");
			...
			{
				// Debug Log PoliceCruiser04 compass is disabled
				//Debug.Log("The PoliceCruiser04 compass is disabled");
				...
				// Get Component PoliceCruiser04Compass is not enabled
				GetComponent<PoliceCruiser04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _policeCruiser04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_policeCruiser04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _policeCruiser04 forward vector

			// Vector3 forward is _policeCruiser04 transform forward
			Vector3 forward = _policeCruiser04.transform.forward;

			// Zero out the Y of _policeCruiser04 forward vector to only get the direction in the X,Z 
	...
	} // close public class PoliceCruiser04Compass
