/*
*  Name: SedanLarge 04 Compass
*  File: SedanLarge04Compass.cs
...
namespace NavigationControl
{
	// public class SedanLarge04Compass
	public class SedanLarge04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SedanLarge04 transform")]
			// Transform _sedanLarge04
			[SerializeField] private Transform _sedanLarge04;
		...
		public static SedanLarge04Compass _sedanLG04Compass;

		// private void Start
		private void Start()
		{
			// _sedanLG04Compass
			_sedanLG04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanLarge04Compass is enabled
				GetComponent<SedanLarge04Compass>().enabled = true;

				// Debug Log SedanLarge04 compass is enabled
			...
			{
				// Debug Log SedanLarge04 compass is disabled
				...
				// Get Component SedanLarge04Compass is not enabled
				GetComponent<SedanLarge04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanLarge04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanLarge04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanLarge04 forward vector

			// Vector3 forward is _sedanLarge04 transform forward
			Vector3 forward = _sedanLarge04.transform.forward;

			// Zero out the Y of _sedanLarge04 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanLarge04Compass
