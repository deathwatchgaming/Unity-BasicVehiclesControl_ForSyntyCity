/*
*  Name: SedanLarge 01 Compass
*  File: SedanLarge01Compass.cs
...
namespace NavigationControl
{
	// public class SedanLarge01Compass
	public class SedanLarge01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SedanLarge01 transform")]
			// Transform _sedanLarge01
			[SerializeField] private Transform _sedanLarge01;
		...
		public static SedanLarge01Compass _sedanLG01Compass;

		// private void Start
		private void Start()
		{
			// _sedanLG01Compass
			_sedanLG01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanLarge01Compass is enabled
				GetComponent<SedanLarge01Compass>().enabled = true;

				// Debug Log SedanLarge01 compass is enabled
			...
			{
				// Debug Log SedanLarge01 compass is disabled
				...
				// Get Component SedanLarge01Compass is not enabled
				GetComponent<SedanLarge01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanLarge01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanLarge01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanLarge01 forward vector

			// Vector3 forward is _sedanLarge01 transform forward
			Vector3 forward = _sedanLarge01.transform.forward;

			// Zero out the Y of _sedanLarge01 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanLarge01Compass
