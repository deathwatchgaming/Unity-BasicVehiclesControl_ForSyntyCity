/*
*  Name: SedanLarge 03 Compass
*  File: SedanLarge03Compass.cs
...
namespace NavigationControl
{
	// public class SedanLarge03Compass
	public class SedanLarge03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		public static SedanLarge03Compass _sedanLG03Compass;

		// private void Start
		private void Start()
		{
			// _sedanLG03Compass
			_sedanLG03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanLarge03Compass is enabled
				GetComponent<SedanLarge03Compass>().enabled = true;

				// Debug Log SedanLarge03 compass is enabled
			...
			{
				// Debug Log SedanLarge03 compass is disabled
				...
				// Get Component SedanLarge03Compass is not enabled
				GetComponent<SedanLarge03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanLarge03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanLarge03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanLarge03 forward vector

			// Vector3 forward is _sedanLarge03 transform forward
			Vector3 forward = _sedanLarge03.transform.forward;

			// Zero out the Y of _sedanLarge03 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanLarge03Compass
