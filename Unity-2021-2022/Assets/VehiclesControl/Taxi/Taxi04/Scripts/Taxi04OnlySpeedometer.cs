/*
 * File: Taxi 04 Only Speedometer
 * Name: Taxi04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Taxi04OnlySpeedUnit
	public enum Taxi04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Taxi04OnlySpeedUnit

	// public class Taxi04OnlySpeedometer 
	public class Taxi04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Taxi04OnlySpeedUnit _speedUnit	
			[SerializeField] private Taxi04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Taxi04OnlySpeedUnit.mph
			if (_speedUnit == Taxi04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Taxi04OnlySpeedUnit.mph
	...
	} // close public class Taxi04OnlySpeedometer
