/*
 * File: Taxi 03 Only Speedometer
 * Name: Taxi03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Taxi03OnlySpeedUnit
	public enum Taxi03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Taxi03OnlySpeedUnit

	// public class Taxi03OnlySpeedometer 
	public class Taxi03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Taxi03OnlySpeedUnit _speedUnit	
			[SerializeField] private Taxi03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Taxi03OnlySpeedUnit.mph
			if (_speedUnit == Taxi03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Taxi03OnlySpeedUnit.mph
	...
	} // close public class Taxi03OnlySpeedometer
