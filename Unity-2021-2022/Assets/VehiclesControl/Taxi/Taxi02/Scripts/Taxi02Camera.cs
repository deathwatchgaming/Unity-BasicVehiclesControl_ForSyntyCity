...
namespace VehiclesControl
{
	...
	public class Taxi02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _taxi02.InverseTransformDirection(_taxi02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _taxi02.GetComponent<Rigidbody>().velocity.magnitude;
