/*
 * File: Taxi 02 Only Speedometer
 * Name: Taxi02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Taxi02OnlySpeedUnit
	public enum Taxi02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Taxi02OnlySpeedUnit

	// public class Taxi02OnlySpeedometer 
	public class Taxi02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Taxi02OnlySpeedUnit _speedUnit	
			[SerializeField] private Taxi02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Taxi02OnlySpeedUnit.mph
			if (_speedUnit == Taxi02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Taxi02OnlySpeedUnit.mph
	...
	} // close public class Taxi02OnlySpeedometer
