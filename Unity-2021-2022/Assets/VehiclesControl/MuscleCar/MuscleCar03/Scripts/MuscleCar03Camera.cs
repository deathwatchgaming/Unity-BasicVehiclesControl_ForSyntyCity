...
namespace VehiclesControl
{
	...
	public class MuscleCar03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _muscleCar03.InverseTransformDirection(_muscleCar03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _muscleCar03.GetComponent<Rigidbody>().velocity.magnitude;
