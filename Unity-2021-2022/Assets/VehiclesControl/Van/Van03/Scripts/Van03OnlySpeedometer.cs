/*
 * File: Van 03 Only Speedometer
 * Name: Van03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Van03OnlySpeedUnit
	public enum Van03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Van03OnlySpeedUnit

	// public class Van03OnlySpeedometer 
	public class Van03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Van03OnlySpeedUnit _speedUnit	
			[SerializeField] private Van03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Van03OnlySpeedUnit.mph
			if (_speedUnit == Van03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Van03OnlySpeedUnit.mph
	...
	} // close public class Van03OnlySpeedometer
