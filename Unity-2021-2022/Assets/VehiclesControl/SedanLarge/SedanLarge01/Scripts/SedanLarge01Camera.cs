...
namespace VehiclesControl
{
	...
	public class SedanLarge01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanLarge01.InverseTransformDirection(_sedanLarge01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanLarge01.GetComponent<Rigidbody>().velocity.magnitude;
