...
namespace VehiclesControl
{
	...
	public class SedanSmall03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanSmall03.InverseTransformDirection(_sedanSmall03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanSmall03.GetComponent<Rigidbody>().velocity.magnitude;
