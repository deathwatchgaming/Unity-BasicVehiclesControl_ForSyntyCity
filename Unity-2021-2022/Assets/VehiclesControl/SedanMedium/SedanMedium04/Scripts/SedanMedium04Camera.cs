...
namespace VehiclesControl
{
	...
	public class SedanMedium04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanMedium04.InverseTransformDirection(_sedanMedium04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedanMedium04.GetComponent<Rigidbody>().velocity.magnitude;
