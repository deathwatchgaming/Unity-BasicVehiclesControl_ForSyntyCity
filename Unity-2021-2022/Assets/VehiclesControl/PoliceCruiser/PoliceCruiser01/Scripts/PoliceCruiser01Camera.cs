...
namespace VehiclesControl
{
	...
	public class PoliceCruiser01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCruiser01.InverseTransformDirection(_policeCruiser01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _policeCruiser01.GetComponent<Rigidbody>().velocity.magnitude;
