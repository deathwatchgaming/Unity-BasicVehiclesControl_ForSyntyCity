...
namespace VehiclesControl
{
	...
	public class PoliceCruiser04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCruiser04.InverseTransformDirection(_policeCruiser04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _policeCruiser04.GetComponent<Rigidbody>().velocity.magnitude;
