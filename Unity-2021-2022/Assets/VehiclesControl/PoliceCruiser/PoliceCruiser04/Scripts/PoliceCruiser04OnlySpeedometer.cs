/*
 * File: PoliceCruiser04 Only Speedometer
 * Name: PoliceCruiser04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum PoliceCruiser04OnlySpeedUnit
	public enum PoliceCruiser04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser04OnlySpeedUnit

	// public class PoliceCruiser04OnlySpeedometer 
	public class PoliceCruiser04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// PoliceCruiser04OnlySpeedUnit _speedUnit	
			[SerializeField] private PoliceCruiser04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals PoliceCruiser04OnlySpeedUnit.mph
			if (_speedUnit == PoliceCruiser04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals PoliceCruiser04OnlySpeedUnit.mph
	...
	} // close public class PoliceCruiser04OnlySpeedometer
