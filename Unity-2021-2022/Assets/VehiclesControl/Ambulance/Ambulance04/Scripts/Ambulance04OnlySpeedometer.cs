/*
 * File: Ambulance 04 Only Speedometer
 * Name: Ambulance04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Ambulance04OnlySpeedUnit
	public enum Ambulance04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Ambulance04OnlySpeedUnit

	// public class Ambulance04OnlySpeedometer 
	public class Ambulance04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Ambulance04OnlySpeedUnit _speedUnit	
			[SerializeField] private Ambulance04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Ambulance04OnlySpeedUnit.mph
			if (_speedUnit == Ambulance04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Ambulance04OnlySpeedUnit.mph
	...
	} // close public class Ambulance04OnlySpeedometer
