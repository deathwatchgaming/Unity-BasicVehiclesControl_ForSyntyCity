/*
 * File: MuscleCar 01 Only Speedometer
 * Name: MuscleCar01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum MuscleCar01OnlySpeedUnit
	public enum MuscleCar01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum MuscleCar01OnlySpeedUnit

	// public class MuscleCar01OnlySpeedometer 
	public class MuscleCar01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// MuscleCar01OnlySpeedUnit _speedUnit	
			[SerializeField] private MuscleCar01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals MuscleCar01OnlySpeedUnit.mph
			if (_speedUnit == MuscleCar01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals MuscleCar01OnlySpeedUnit.mph
	...
	} // close public class MuscleCar01OnlySpeedometer
