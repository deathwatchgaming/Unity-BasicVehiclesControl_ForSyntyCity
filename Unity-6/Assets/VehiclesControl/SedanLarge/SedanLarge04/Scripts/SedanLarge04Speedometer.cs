...
namespace VehiclesControl
{
    // public enum SedanLarge04SpeedUnit
	public enum SedanLarge04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanLarge04SpeedUnit

	// public class SedanLarge04Speedometer 
	public class SedanLarge04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanLarge04SpeedUnit _speedUnit	
			[SerializeField] private SedanLarge04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanLarge04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanLarge04_SpeedoGuage");

			// GameObject _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanLarge04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanLarge04_SpeedoNeedle");

			// GameObject _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanLarge04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanLarge04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanLarge04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanLarge04Speedometer");
		...
		private void Update()
		{
			...
			} // close if _speedUnit equals SedanLarge04SpeedUnit.mph
	...
	} // close public class SedanLarge04Speedometer
