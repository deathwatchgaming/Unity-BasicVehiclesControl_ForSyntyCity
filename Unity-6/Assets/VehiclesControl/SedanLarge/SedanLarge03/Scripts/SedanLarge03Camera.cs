...
namespace VehiclesControl
{
	...
	public class SedanLarge03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanLarge03.InverseTransformDirection(_sedanLarge03.GetComponent<Rigidbody>().linearVelocity);
			...
			float _autoCamControl = _sedanLarge03.GetComponent<Rigidbody>().linearVelocity.magnitude;
