...
namespace VehiclesControl
{
	// public class Taxi01Camera
	public class Taxi01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _taxi01.position.y plus _height
			float _desiredHeight = _taxi01.position.y + _height;
			...
			// transform position is _taxi01.position
			transform.position = _taxi01.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _taxi01.InverseTransformDirection(_taxi01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _taxi01.eulerAngles.y plus 180
				_tempVector3.y = _taxi01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _taxi01.eulerAngles.y
				_tempVector3.y = _taxi01.eulerAngles.y;
			...
			float _autoCamControl = _taxi01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Taxi01Camera
