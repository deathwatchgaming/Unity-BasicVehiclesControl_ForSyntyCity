/*
 * File: SedanMedium 02 Camera
 * Name: SedanMedium02Camera.cs
...
namespace VehiclesControl
{
	// public class SedanMedium02Camera
	public class SedanMedium02Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanMedium02.position.y plus _height
			float _desiredHeight = _sedanMedium02.position.y + _height;
			...
			// transform position is _sedanMedium02.position
			transform.position = _sedanMedium02.position;
			...
			// transform LookAt _sedanMedium02
			transform.LookAt(_sedanMedium02);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanMedium02.InverseTransformDirection(_sedanMedium02.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanMedium02.eulerAngles.y plus 180
				_tempVector3.y = _sedanMedium02.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanMedium02.eulerAngles.y
				_tempVector3.y = _sedanMedium02.eulerAngles.y;
			...
			float _autoCamControl = _sedanMedium02.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanMedium02Camera
