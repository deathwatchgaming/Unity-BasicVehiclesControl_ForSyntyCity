/*
 * File: SedanMedium 02 Only Speedometer
 * Name: SedanMedium02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanMedium02OnlySpeedUnit
	public enum SedanMedium02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanMedium02OnlySpeedUnit

	// public class SedanMedium02OnlySpeedometer 
	public class SedanMedium02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanMedium02OnlySpeedUnit _speedUnit	
			[SerializeField] private SedanMedium02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanMedium02OnlySpeedUnit.mph
			if (_speedUnit == SedanMedium02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanMedium02OnlySpeedUnit.mph
	...
	} // close public class SedanMedium02OnlySpeedometer
