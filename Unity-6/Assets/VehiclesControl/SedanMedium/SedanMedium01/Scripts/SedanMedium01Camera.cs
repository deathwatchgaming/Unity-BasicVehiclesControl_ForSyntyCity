...
namespace VehiclesControl
{
	...
	public class SedanMedium01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanMedium01.InverseTransformDirection(_sedanMedium01.GetComponent<Rigidbody>().linearVelocity);
			...
			float _autoCamControl = _sedanMedium01.GetComponent<Rigidbody>().linearVelocity.magnitude;
