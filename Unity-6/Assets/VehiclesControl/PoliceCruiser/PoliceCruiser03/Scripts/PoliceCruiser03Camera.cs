/*
 * File: Police Cruiser 03 Camera
 * Name: PoliceCruiser03Camera.cs
...
namespace VehiclesControl
{
	// public class PoliceCruiser03Camera
	public class PoliceCruiser03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The police cruiser 03 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _policeCruiser03.position.y plus _height
			float _desiredHeight = _policeCruiser03.position.y + _height;
			...
			// transform position is _policeCruiser03.position
			transform.position = _policeCruiser03.position;
			...
			// transform LookAt _policeCruiser03
			transform.LookAt(_policeCruiser03);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCruiser03.InverseTransformDirection(_policeCruiser03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _policeCruiser03.eulerAngles.y plus 180
				_tempVector3.y = _policeCruiser03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _policeCruiser03.eulerAngles.y
				_tempVector3.y = _policeCruiser03.eulerAngles.y;
			...
			float _autoCamControl = _policeCruiser03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class PoliceCruiser03Camera
