/*
 * File: SedanSmall 03 Camera
 * Name: SedanSmall03Camera.cs
...
namespace VehiclesControl
{
	// public class SedanSmall03Camera
	public class SedanSmall03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanSmall03.position.y plus _height
			float _desiredHeight = _sedanSmall03.position.y + _height;
			...
			// transform position is _sedanSmall03.position
			transform.position = _sedanSmall03.position;
			...
			// transform LookAt _sedanSmall03
			transform.LookAt(_sedanSmall03);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanSmall03.InverseTransformDirection(_sedanSmall03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanSmall03.eulerAngles.y plus 180
				_tempVector3.y = _sedanSmall03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanSmall03.eulerAngles.y
				_tempVector3.y = _sedanSmall03.eulerAngles.y;
			...
			float _autoCamControl = _sedanSmall03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanSmall03Camera
