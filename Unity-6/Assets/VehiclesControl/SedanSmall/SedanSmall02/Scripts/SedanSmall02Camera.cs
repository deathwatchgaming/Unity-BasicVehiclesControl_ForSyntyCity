/*
 * File: SedanSmall 02 Camera
 * Name: SedanSmall02Camera.cs
...
namespace VehiclesControl
{
	// public class SedanSmall02Camera
	public class SedanSmall02Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanSmall02.position.y plus _height
			float _desiredHeight = _sedanSmall02.position.y + _height;
			...
			// transform position is _sedanSmall02.position
			transform.position = _sedanSmall02.position;
			...
			// transform LookAt _sedanSmall02
			transform.LookAt(_sedanSmall02);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanSmall02.InverseTransformDirection(_sedanSmall02.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanSmall02.eulerAngles.y plus 180
				_tempVector3.y = _sedanSmall02.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanSmall02.eulerAngles.y
				_tempVector3.y = _sedanSmall02.eulerAngles.y;
			...
			float _autoCamControl = _sedanSmall02.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanSmall02Camera
