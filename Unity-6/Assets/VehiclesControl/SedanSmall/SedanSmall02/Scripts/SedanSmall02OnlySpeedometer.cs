/*
 * File: SedanSmall 02 Only Speedometer
 * Name: SedanSmall02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanSmall02OnlySpeedUnit
	public enum SedanSmall02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanSmall02OnlySpeedUnit

	// public class SedanSmall02OnlySpeedometer 
	public class SedanSmall02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanSmall02OnlySpeedUnit _speedUnit	
			[SerializeField] private SedanSmall02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanSmall02OnlySpeedUnit.mph
			if (_speedUnit == SedanSmall02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanSmall02OnlySpeedUnit.mph
	...
	} // close public class SedanSmall02OnlySpeedometer
