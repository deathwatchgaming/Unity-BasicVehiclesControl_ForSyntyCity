/*
 * File: SedanSmall 04 Camera
 * Name: SedanSmall04Camera.cs
...
namespace VehiclesControl
{
	// public class SedanSmall04Camera
	public class SedanSmall04Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedanSmall04.position.y plus _height
			float _desiredHeight = _sedanSmall04.position.y + _height;
			...
			// transform position is _sedanSmall04.position
			transform.position = _sedanSmall04.position;
			...
			// transform LookAt _sedanSmall04
			transform.LookAt(_sedanSmall04);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedanSmall04.InverseTransformDirection(_sedanSmall04.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedanSmall04.eulerAngles.y plus 180
				_tempVector3.y = _sedanSmall04.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedanSmall04.eulerAngles.y
				_tempVector3.y = _sedanSmall04.eulerAngles.y;
			...
			float _autoCamControl = _sedanSmall04.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SedanSmall04Camera
