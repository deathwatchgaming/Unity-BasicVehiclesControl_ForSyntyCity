/*
 * File: SedanSmall 04 Only Speedometer
 * Name: SedanSmall04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanSmall04OnlySpeedUnit
	public enum SedanSmall04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanSmall04OnlySpeedUnit

	// public class SedanSmall04OnlySpeedometer 
	public class SedanSmall04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanSmall04OnlySpeedUnit _speedUnit	
			[SerializeField] private SedanSmall04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanSmall04OnlySpeedUnit.mph
			if (_speedUnit == SedanSmall04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanSmall04OnlySpeedUnit.mph
	...
	} // close public class SedanSmall04OnlySpeedometer
