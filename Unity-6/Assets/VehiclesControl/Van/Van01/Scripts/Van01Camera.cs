...
namespace VehiclesControl
{
	// public class Van01Camera
	public class Van01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _van01.position.y plus _height
			float _desiredHeight = _van01.position.y + _height;
			...
			// transform position is _van01.position
			transform.position = _van01.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _van01.InverseTransformDirection(_van01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _van01.eulerAngles.y plus 180
				_tempVector3.y = _van01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _van01.eulerAngles.y
				_tempVector3.y = _van01.eulerAngles.y;
			...
			float _autoCamControl = _van01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Van01Camera
