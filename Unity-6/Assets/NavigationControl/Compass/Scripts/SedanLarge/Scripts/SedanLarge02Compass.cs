/*
*  Name: SedanLarge 02 Compass
*  File: SedanLarge02Compass.cs
...
namespace NavigationControl
{
	// public class SedanLarge02Compass
	public class SedanLarge02Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SedanLarge02 transform")]
			// Transform _sedanLarge02
			[SerializeField] private Transform _sedanLarge02;
		...
		public static SedanLarge02Compass _sedanLG02Compass;

		// private void Start
		private void Start()
		{
			// _sedanLG02Compass
			_sedanLG02Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanLarge02Compass is enabled
				GetComponent<SedanLarge02Compass>().enabled = true;

				// Debug Log SedanLarge02 compass is enabled
			...
			{
				// Debug Log SedanLarge02 compass is disabled
				...
				// Get Component SedanLarge02Compass is not enabled
				GetComponent<SedanLarge02Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanLarge02 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanLarge02.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanLarge02 forward vector

			// Vector3 forward is _sedanLarge02 transform forward
			Vector3 forward = _sedanLarge02.transform.forward;

			// Zero out the Y of _sedanLarge02 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanLarge02Compass
