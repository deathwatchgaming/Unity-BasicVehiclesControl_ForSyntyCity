/*
*  Name: SedanMedium 04 Compass
*  File: SedanMedium04Compass.cs
...
namespace NavigationControl
{
	// public class SedanMedium04Compass
	public class SedanMedium04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SedanMedium04 transform")]
			// Transform _sedanMedium04
			[SerializeField] private Transform _sedanMedium04;
		...
		public static SedanMedium04Compass _sedanMD04Compass;

		// private void Start
		private void Start()
		{
			// _sedanMD04Compass
			_sedanMD04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanMedium04Compass is enabled
				GetComponent<SedanMedium04Compass>().enabled = true;

				// Debug Log SedanMedium04 compass is enabled
				//Debug.Log("The SedanMedium04 compass is enabled");
			...
			{
				// Debug Log SedanMedium04 compass is disabled
				//Debug.Log("The SedanMedium04 compass is disabled");
				...
				// Get Component SedanMedium04Compass is not enabled
				GetComponent<SedanMedium04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanMedium04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanMedium04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanMedium04 forward vector

			// Vector3 forward is _sedanMedium04 transform forward
			Vector3 forward = _sedanMedium04.transform.forward;

			// Zero out the Y of _sedanMedium04 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanMedium04Compass
