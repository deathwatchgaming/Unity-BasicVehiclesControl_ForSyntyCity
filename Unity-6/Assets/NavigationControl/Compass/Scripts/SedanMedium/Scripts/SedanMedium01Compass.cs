/*
*  Name: SedanMedium 01 Compass
*  File: SedanMedium01Compass.cs
...
namespace NavigationControl
{
	// public class SedanMedium01Compass
	public class SedanMedium01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		public static SedanMedium01Compass _sedanMD01Compass;

		// private void Start
		private void Start()
		{
			// _sedanMD01Compass
			_sedanMD01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanMedium01Compass is enabled
				GetComponent<SedanMedium01Compass>().enabled = true;

				// Debug Log SedanMedium01 compass is enabled
			...
			{
				// Debug Log SedanMedium01 compass is disabled
				...
				// Get Component SedanMedium01Compass is not enabled
				GetComponent<SedanMedium01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanMedium01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanMedium01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanMedium01 forward vector

			// Vector3 forward is _sedanMedium01 transform forward
			Vector3 forward = _sedanMedium01.transform.forward;

			// Zero out the Y of _sedanMedium01 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanMedium01Compass
