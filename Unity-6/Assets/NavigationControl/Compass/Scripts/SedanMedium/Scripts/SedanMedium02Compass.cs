/*
*  Name: SedanMedium 02 Compass
*  File: SedanMedium02Compass.cs
...
namespace NavigationControl
{
	// public class SedanMedium02Compass
	public class SedanMedium02Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SedanMedium02 transform")]
			// Transform _sedanMedium02
			[SerializeField] private Transform _sedanMedium02;
		...
		public static SedanMedium02Compass _sedanMD02Compass;

		// private void Start
		private void Start()
		{
			// _sedanMD02Compass
			_sedanMD02Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanMedium02Compass is enabled
				GetComponent<SedanMedium02Compass>().enabled = true;

				// Debug Log SedanMedium02 compass is enabled
			...
			{
				// Debug Log SedanMedium02 compass is disabled
				...
				// Get Component SedanMedium02Compass is not enabled
				GetComponent<SedanMedium02Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanMedium02 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanMedium02.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanMedium02 forward vector

			// Vector3 forward is _sedanMedium02 transform forward
			Vector3 forward = _sedanMedium02.transform.forward;

			// Zero out the Y of _sedanMedium02 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanMedium02Compass
