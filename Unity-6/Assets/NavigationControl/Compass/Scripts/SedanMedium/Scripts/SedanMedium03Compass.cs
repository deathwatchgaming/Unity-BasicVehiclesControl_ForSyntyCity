/*
*  Name: SedanMedium 03 Compass
*  File: SedanMedium03Compass.cs
...
namespace NavigationControl
{
	// public class SedanMedium03Compass
	public class SedanMedium03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SedanMedium03 transform")]
			// Transform _sedanMedium03
			[SerializeField] private Transform _sedanMedium03;
		...
		public static SedanMedium03Compass _sedanMD03Compass;

		// private void Start
		private void Start()
		{
			// _sedanMD03Compass
			_sedanMD03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanMedium03Compass is enabled
				GetComponent<SedanMedium03Compass>().enabled = true;

				// Debug Log SedanMedium03 compass is enabled
			...
			{
				// Debug Log SedanMedium03 compass is disabled
				...
				// Get Component SedanMedium03Compass is not enabled
				GetComponent<SedanMedium03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanMedium03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanMedium03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanMedium03 forward vector

			// Vector3 forward is _sedanMedium03 transform forward
			Vector3 forward = _sedanMedium03.transform.forward;

			// Zero out the Y of _sedanMedium03 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanMedium03Compass
