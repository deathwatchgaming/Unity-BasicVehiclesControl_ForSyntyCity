/*
*  Name: Police Cruiser 03 Compass
*  File: PoliceCruiser03Compass.cs
...
namespace NavigationControl
{
	// public class PoliceCruiser03Compass
	public class PoliceCruiser03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The PoliceCruiser03 transform")]
			// Transform _policeCruiser03
			[SerializeField] private Transform _policeCruiser03;
		...
		public static PoliceCruiser03Compass _cruiser03Compass;

		// private void Start
		private void Start()
		{
			// _cruiser03Compass
			_cruiser03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component PoliceCruiser03Compass is enabled
				GetComponent<PoliceCruiser03Compass>().enabled = true;

				// Debug Log PoliceCruiser03 compass is enabled
				//Debug.Log("The PoliceCruiser03 compass is enabled");
			...
			{
				// Debug Log PoliceCruiser03 compass is disabled
				//Debug.Log("The PoliceCruiser03 compass is disabled");
				...
				// Get Component PoliceCruiser03Compass is not enabled
				GetComponent<PoliceCruiser03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _policeCruiser03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_policeCruiser03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _policeCruiser03 forward vector

			// Vector3 forward is _policeCruiser03 transform forward
			Vector3 forward = _policeCruiser03.transform.forward;

			// Zero out the Y of _policeCruiser03 forward vector to only get the direction in the X,Z 
	...
	} // close public class PoliceCruiser03Compass
