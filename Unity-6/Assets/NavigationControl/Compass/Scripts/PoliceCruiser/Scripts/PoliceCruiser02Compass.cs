/*
*  Name: Police Cruiser 02 Compass
*  File: PoliceCruiser02Compass.cs
...
namespace NavigationControl
{
	// public class PoliceCruiser02Compass
	public class PoliceCruiser02Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The PoliceCruiser02 transform")]
			// Transform _policeCruiser02
			[SerializeField] private Transform _policeCruiser02;
		...
		public static PoliceCruiser02Compass _cruiser02Compass;

		// private void Start
		private void Start()
		{
			// _cruiser02Compass
			_cruiser02Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component PoliceCruiser02Compass is enabled
				GetComponent<PoliceCruiser02Compass>().enabled = true;

				// Debug Log PoliceCruiser02 compass is enabled
				//Debug.Log("The PoliceCruiser02 compass is enabled");
			...
			{
				// Debug Log PoliceCruiser02 compass is disabled
				//Debug.Log("The PoliceCruiser02 compass is disabled");
				...
				// Get Component PoliceCruiser02Compass is not enabled
				GetComponent<PoliceCruiser02Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _policeCruiser02 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_policeCruiser02.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _policeCruiser02 forward vector

			// Vector3 forward is _policeCruiser02 transform forward
			Vector3 forward = _policeCruiser02.transform.forward;

			// Zero out the Y of _policeCruiser02 forward vector to only get the direction in the X,Z 
	...
	} // close public class PoliceCruiser02Compass
