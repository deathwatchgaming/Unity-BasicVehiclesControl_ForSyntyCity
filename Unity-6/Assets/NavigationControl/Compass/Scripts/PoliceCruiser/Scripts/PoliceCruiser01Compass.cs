/*
*  Name: Police Cruiser 01 Compass
*  File: PoliceCruiser01Compass.cs
...
namespace NavigationControl
{
	// public class PoliceCruiser01Compass
	public class PoliceCruiser01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The PoliceCruiser01 transform")]
			// Transform _policeCruiser01
			[SerializeField] private Transform _policeCruiser01;
		...
		// PoliceCruiser01Compass _cruiser01Compass
		public static PoliceCruiser01Compass _cruiser01Compass;

		// private void Start
		private void Start()
		{
			// _cruiser01Compass
			_cruiser01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component PoliceCruiser01Compass is enabled
				GetComponent<PoliceCruiser01Compass>().enabled = true;

				// Debug Log PoliceCruiser01 compass is enabled
				//Debug.Log("The PoliceCruiser01 compass is enabled");
			...
			{
				// Debug Log PoliceCruiser01 compass is disabled
				//Debug.Log("The PoliceCruiser01 compass is disabled");
				...
				// Get Component PoliceCruiser01Compass is not enabled
				GetComponent<PoliceCruiser01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _policeCruiser01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_policeCruiser01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _policeCruiser01 forward vector

			// Vector3 forward is _policeCruiser01 transform forward
			Vector3 forward = _policeCruiser01.transform.forward;

			// Zero out the Y of _policeCruiser01 forward vector to only get the direction in the X,Z 
	...
	} // close public class PoliceCruiser01Compass
