/*
*  Name: SedanSmall 04 Compass
*  File: SedanSmall04Compass.cs
...
namespace NavigationControl
{
	// public class SedanSmall04Compass
	public class SedanSmall04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SedanSmall04 transform")]
			// Transform _sedanSmall04
			[SerializeField] private Transform _sedanSmall04;
		...
		// SedanSmall04Compass _sedanSM04Compass
		public static SedanSmall04Compass _sedanSM04Compass;

		// private void Start
		private void Start()
		{
			// _sedanSM04Compass
			_sedanSM04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanSmall04Compass is enabled
				GetComponent<SedanSmall04Compass>().enabled = true;

				// Debug Log SedanSmall04 compass is enabled
			...
			{
				// Debug Log SedanSmall04 compass is disabled
				...
				// Get Component SedanSmall04Compass is not enabled
				GetComponent<SedanSmall04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanSmall04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanSmall04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanSmall04 forward vector

			// Vector3 forward is _sedanSmall04 transform forward
			Vector3 forward = _sedanSmall04.transform.forward;

			// Zero out the Y of _sedanSmall04 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanSmall04Compass
