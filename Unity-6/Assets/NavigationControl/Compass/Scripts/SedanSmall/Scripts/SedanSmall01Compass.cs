/*
*  Name: SedanSmall 01 Compass
*  File: SedanSmall01Compass.cs
...
namespace NavigationControl
{
	// public class SedanSmall01Compass
	public class SedanSmall01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SedanSmall01 transform")]
			// Transform _sedanSmall01
			[SerializeField] private Transform _sedanSmall01;
		...
		public static SedanSmall01Compass _sedanSM01Compass;

		// private void Start
		private void Start()
		{
			// _sedanSM01Compass
			_sedanSM01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SedanSmall01Compass is enabled
				GetComponent<SedanSmall01Compass>().enabled = true;

				// Debug Log SedanSmall01 compass is enabled
			...
			{
				// Debug Log SedanSmall01 compass is disabled
				...
				// Get Component SedanSmall01Compass is not enabled
				GetComponent<SedanSmall01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedanSmall01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedanSmall01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedanSmall01 forward vector

			// Vector3 forward is _sedanSmall01 transform forward
			Vector3 forward = _sedanSmall01.transform.forward;

			// Zero out the Y of _sedanSmall01 forward vector to only get the direction in the X,Z 
	...
	} // close public class SedanSmall01Compass
