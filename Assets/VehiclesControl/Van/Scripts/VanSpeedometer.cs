/*
 * File: Van Speedometer
 * Name: VanSpeedometer.cs
...
namespace VehiclesControl
{
    // public enum VanSpeedUnit
	public enum VanSpeedUnit
	{
		mph,
		kmh	

	} // close public enum VanSpeedUnit

	// public class VanSpeedometer 
	public class VanSpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// VanSpeedUnit _speedUnit	
			[SerializeField] private VanSpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Van_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Van_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Van_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Van_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Van_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Van_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName VanSpeedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("VanSpeedometer");
		...
		private void Update()
		{
			// if _speedUnit equals VanSpeedUnit.mph
			if (_speedUnit == VanSpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals VanSpeedUnit.mph
	...
	} // close public class VanSpeedometer
