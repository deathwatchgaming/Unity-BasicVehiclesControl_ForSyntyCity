...
namespace VehiclesControl
{
	// public enum VanSpeedType
	public enum VanSpeedType
	{
		mph,
		kmh	

	} // close public enum VanSpeedType
	...
	public class VanController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// VanSpeedType _speedType	
			[SerializeField] private VanSpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the Van from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals VanSpeedType.mph
			if (_speedType == VanSpeedType.mph)
			{
			...
			} // close if _speedType equals VanSpeedType.mph

			// else if _speedType equals VanSpeedType.kmh
			else if (_speedType == VanSpeedType.kmh)
			{
			...
			} // close else if _speedType equals VanSpeedType.kmh

		} // close private void HandleSpeed

	} // close public class VanController
