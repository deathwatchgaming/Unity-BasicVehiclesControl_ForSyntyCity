...
namespace VehiclesControl
{
	...
	public class AmbulanceSpeedometer : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Ambulance_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Ambulance_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Ambulance_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Ambulance_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Ambulance_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Ambulance_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName AmbulanceSpeedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("AmbulanceSpeedometer");
