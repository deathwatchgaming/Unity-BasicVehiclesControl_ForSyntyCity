/*
 * File: Ambulance Controller
 * Name: AmbulanceController.cs
...
namespace VehiclesControl
{
	// public enum AmbulanceSpeedType
	public enum AmbulanceSpeedType
	{
		mph,
		kmh	

	} // close public enum AmbulanceSpeedType
	...
	public class AmbulanceController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// AmbulanceSpeedType _speedType	
			[SerializeField] private AmbulanceSpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the ambulance from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals AmbulanceSpeedType.mph
			if (_speedType == AmbulanceSpeedType.mph)
			{
			...
			} // close if _speedType equals AmbulanceSpeedType.mph

			// else if _speedType equals AmbulanceSpeedType.kmh
			else if (_speedType == AmbulanceSpeedType.kmh)
			{
			...
			} // close else if _speedType equals AmbulanceSpeedType.kmh

		} // close private void HandleSpeed

	} // close public class AmbulanceController
