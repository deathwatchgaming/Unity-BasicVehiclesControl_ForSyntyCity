...
namespace VehiclesControl
{
    ...
    {   
        ...
        private void Start() 
        {
            ...
            // GameObject _interfaceTextObject is FindInActiveObjectByName SedanSmall_EntryKey
            GameObject _interfaceTextObject = FindInActiveObjectByName("SedanSmall_EntryKey");
