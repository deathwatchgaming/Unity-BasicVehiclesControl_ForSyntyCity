/*
 * File: SedanSmall Controller
 * Name: SedanSmallController.cs
...
namespace VehiclesControl
{
	// public enum SedanSmallSpeedType
	public enum SedanSmallSpeedType
	{
		mph,
		kmh	

	} // close public enum SedanSmallSpeedType
	...
	// public class SedanSmallController
	public class SedanSmallController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// SedanSmallSpeedType _speedType	
			[SerializeField] private SedanSmallSpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanSmall car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanSmallSpeedType.mph
			if (_speedType == SedanSmallSpeedType.mph)
			{
			...
			} // close if _speedType equals SedanSmallSpeedType.mph

			// else if _speedType equals SedanSmallSpeedType.kmh
			else if (_speedType == SedanSmallSpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanSmallSpeedType.kmh

		} // close private void HandleSpeed

	} // close public class SedanSmallController
