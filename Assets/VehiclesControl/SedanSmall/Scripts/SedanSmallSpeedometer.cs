/*
 * File: SedanSmall Speedometer
 * Name: SedanSmallSpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanSmallSpeedUnit
	public enum SedanSmallSpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanSmallSpeedUnit

	// public class SedanSmallSpeedometer 
	public class SedanSmallSpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanSmallSpeedUnit _speedUnit	
			[SerializeField] private SedanSmallSpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanSmall_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanSmall_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanSmall_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanSmall_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanSmall_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanSmall_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanSmallSpeedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanSmallSpeedometer");
		...
		private void Update()
		{
			// if _speedUnit equals SedanSmallSpeedUnit.mph
			if (_speedUnit == SedanSmallSpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanSmallSpeedUnit.mph
	...
	} // close public class SedanSmallSpeedometer
