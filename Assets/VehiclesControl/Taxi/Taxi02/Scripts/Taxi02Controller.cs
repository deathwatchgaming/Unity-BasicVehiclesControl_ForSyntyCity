/*
 * File: Taxi 02 Controller
 * Name: Taxi02Controller.cs
...
namespace VehiclesControl
{
	// public enum Taxi02SpeedType
	public enum Taxi02SpeedType
	{
		mph,
		kmh	

	} // close public enum Taxi02SpeedType
	...
	// public class Taxi02Controller
	public class Taxi02Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// Taxi02SpeedType _speedType	
			[SerializeField] private Taxi02SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Taxi02SpeedType.mph
			if (_speedType == Taxi02SpeedType.mph)
			{
			...
			} // close if _speedType equals Taxi02SpeedType.mph

			// else if _speedType equals Taxi02SpeedType.kmh
			else if (_speedType == Taxi02SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Taxi02SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class Taxi02Controller
