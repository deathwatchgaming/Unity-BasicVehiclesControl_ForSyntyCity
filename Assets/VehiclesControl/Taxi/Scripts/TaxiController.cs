/*
 * File: Taxi Controller
 * Name: TaxiController.cs
...
namespace VehiclesControl
{
	// public enum TaxiSpeedType
	public enum TaxiSpeedType
	{
		mph,
		kmh	

	} // close public enum TaxiSpeedType
	...
	public class TaxiController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// TaxiSpeedType _speedType	
			[SerializeField] private TaxiSpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the taxi car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals TaxiSpeedType.mph
			if (_speedType == TaxiSpeedType.mph)
			{
			...
			} // close if _speedType equals TaxiSpeedType.mph

			// else if _speedType equals TaxiSpeedType.kmh
			else if (_speedType == TaxiSpeedType.kmh)
			{
			...
			} // close else if _speedType equals TaxiSpeedType.kmh

		} // close private void HandleSpeed

	} // close public class TaxiController
