/*
 * File: Taxi 01 Controller
 * Name: Taxi01Controller.cs
...
namespace VehiclesControl
{
	// public enum Taxi01SpeedType
	public enum Taxi01SpeedType
	{
		mph,
		kmh	

	} // close public enum Taxi01SpeedType
	...
	// public class Taxi01Controller
	public class Taxi01Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// Taxi01SpeedType _speedType	
			[SerializeField] private Taxi01SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the taxi01 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Taxi01SpeedType.mph
			if (_speedType == Taxi01SpeedType.mph)
			{
			...
			} // close if _speedType equals Taxi01SpeedType.mph

			// else if _speedType equals Taxi01SpeedType.kmh
			else if (_speedType == Taxi01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Taxi01SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class Taxi01Controller
