/*
 * File: Taxi 04 Controller
 * Name: Taxi04Controller.cs
...
namespace VehiclesControl
{
	// public enum Taxi04SpeedType
	public enum Taxi04SpeedType
	{
		mph,
		kmh	

	} // close public enum Taxi04SpeedType
	...
	// public class Taxi04Controller
	public class Taxi04Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// Taxi04SpeedType _speedType	
			[SerializeField] private Taxi04SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the taxi04 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Taxi04SpeedType.mph
			if (_speedType == Taxi04SpeedType.mph)
			{
			...
			} // close if _speedType equals Taxi04SpeedType.mph

			// else if _speedType equals Taxi04SpeedType.kmh
			else if (_speedType == Taxi04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Taxi04SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class Taxi04Controller
