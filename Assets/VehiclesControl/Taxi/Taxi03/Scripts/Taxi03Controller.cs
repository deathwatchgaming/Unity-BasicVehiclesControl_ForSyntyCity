/*
 * File: Taxi 03 Controller
 * Name: Taxi03Controller.cs
...
namespace VehiclesControl
{
	// public enum Taxi03SpeedType
	public enum Taxi03SpeedType
	{
		mph,
		kmh	

	} // close public enum Taxi03SpeedType
	...
	// public class Taxi03Controller
	public class Taxi03Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// Taxi03SpeedType _speedType	
			[SerializeField] private Taxi03SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the taxi03 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Taxi03SpeedType.mph
			if (_speedType == Taxi03SpeedType.mph)
			{
			...
			} // close if _speedType equals Taxi03SpeedType.mph

			// else if _speedType equals Taxi03SpeedType.kmh
			else if (_speedType == Taxi03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Taxi03SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class Taxi03Controller
