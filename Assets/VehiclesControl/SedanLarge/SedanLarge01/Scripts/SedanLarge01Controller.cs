/*
 * File: SedanLarge 01 Controller
 * Name: SedanLarge01Controller.cs
...
namespace VehiclesControl
{
	// public enum SedanLarge01SpeedType
	public enum SedanLarge01SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanLarge01SpeedType
	...
	// public class SedanLarge01Controller
	public class SedanLarge01Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// SedanLarge01SpeedType _speedType	
			[SerializeField] private SedanLarge01SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanLarge01 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanLarge01SpeedType.mph
			if (_speedType == SedanLarge01SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanLarge01SpeedType.mph

			// else if _speedType equals SedanLarge01SpeedType.kmh
			else if (_speedType == SedanLarge01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanLarge01SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class SedanLarge01Controller
