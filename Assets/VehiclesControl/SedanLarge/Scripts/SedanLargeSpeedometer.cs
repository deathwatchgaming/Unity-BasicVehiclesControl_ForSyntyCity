/*
 * File: SedanLarge Speedometer
 * Name: SedanLargeSpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanLargeSpeedUnit
	public enum SedanLargeSpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanLargeSpeedUnit

	// public class SedanLargeSpeedometer 
	public class SedanLargeSpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanLargeSpeedUnit _speedUnit	
			[SerializeField] private SedanLargeSpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanLargeSpeedUnit.mph
			if (_speedUnit == SedanLargeSpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanLargeSpeedUnit.mph
	...
	} // close public class SedanLargeSpeedometer
