/*
 * File: SedanLarge Controller
 * Name: SedanLargeController.cs
...
namespace VehiclesControl
{
	// public enum SedanLargeSpeedType
	public enum SedanLargeSpeedType
	{
		mph,
		kmh	

	} // close public enum SedanLargeSpeedType
	...
	// public class SedanLargeController
	public class SedanLargeController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// SedanLargeSpeedType _speedType	
			[SerializeField] private SedanLargeSpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanLarge car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanLargeSpeedType.mph
			if (_speedType == SedanLargeSpeedType.mph)
			{
			...
			} // close if _speedType equals SedanLargeSpeedType.mph

			// else if _speedType equals SedanLargeSpeedType.kmh
			else if (_speedType == SedanLargeSpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanLargeSpeedType.kmh

		} // close private void HandleSpeed

	} // close public class SedanLargeController
