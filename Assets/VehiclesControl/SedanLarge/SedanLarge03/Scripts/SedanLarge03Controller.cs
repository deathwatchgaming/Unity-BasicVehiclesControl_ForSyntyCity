/*
 * File: SedanLarge 03 Controller
 * Name: SedanLarge03Controller.cs
...
namespace VehiclesControl
{
	// public enum SedanLarge03SpeedType
	public enum SedanLarge03SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanLarge03SpeedType
	...
	// public class SedanLarge03Controller
	public class SedanLarge03Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// SedanLarge03SpeedType _speedType	
			[SerializeField] private SedanLarge03SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanLarge03 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanLarge03SpeedType.mph
			if (_speedType == SedanLarge03SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanLarge03SpeedType.mph

			// else if _speedType equals SedanLarge03SpeedType.kmh
			else if (_speedType == SedanLarge03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanLarge03SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class SedanLarge03Controller
