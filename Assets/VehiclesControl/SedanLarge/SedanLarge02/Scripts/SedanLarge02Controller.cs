/*
 * File: SedanLarge 02 Controller
 * Name: SedanLarge02Controller.cs
...
namespace VehiclesControl
{
	// public enum SedanLarge02SpeedType
	public enum SedanLarge02SpeedType
	{
		mph,
		kmh	

	} // close public enum SedanLarge02SpeedType
	...
	// public class SedanLarge02Controller
	public class SedanLarge02Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// SedanLarge02SpeedType _speedType	
			[SerializeField] private SedanLarge02SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanLarge02 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanLarge02SpeedType.mph
			if (_speedType == SedanLarge02SpeedType.mph)
			{
			...
			} // close if _speedType equals SedanLarge02SpeedType.mph

			// else if _speedType equals SedanLarge02SpeedType.kmh
			else if (_speedType == SedanLarge02SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanLarge02SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class SedanLarge02Controller
