/*
 * File: MuscleCar Controller
 * Name: MuscleCarController.cs
...
namespace VehiclesControl
{
	// public enum MuscleCarSpeedType
	public enum MuscleCarSpeedType
	{
		mph,
		kmh	

	} // close public enum MuscleCarSpeedType
	...
	public class MuscleCarController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// MuscleCarSpeedType _speedType	
			[SerializeField] private MuscleCarSpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the muscleCar car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals MuscleCarSpeedType.mph
			if (_speedType == MuscleCarSpeedType.mph)
			{
			...
			} // close if _speedType equals MuscleCarSpeedType.mph

			// else if _speedType equals MuscleCarSpeedType.kmh
			else if (_speedType == MuscleCarSpeedType.kmh)
			{
			...
			} // close else if _speedType equals MuscleCarSpeedType.kmh

		} // close private void HandleSpeed

	} // close public class MuscleCarController
