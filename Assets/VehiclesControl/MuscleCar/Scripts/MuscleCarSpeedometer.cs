/*
 * File: MuscleCar Speedometer
 * Name: MuscleCarSpeedometer.cs
...
namespace VehiclesControl
{
    // public enum MuscleCarSpeedUnit
	public enum MuscleCarSpeedUnit
	{
		mph,
		kmh	

	} // close public enum MuscleCarSpeedUnit

	// public class MuscleCarSpeedometer 
	public class MuscleCarSpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// MuscleCarSpeedUnit _speedUnit	
			[SerializeField] private MuscleCarSpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject_interfaceIMG01Object is FindInActiveObjectByName MuscleCar_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("MuscleCar_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName MuscleCar_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("MuscleCar_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName MuscleCar_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("MuscleCar_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName MuscleCarSpeedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("MuscleCarSpeedometer");
		...
		private void Update()
		{
			// if _speedUnit equals MuscleCarSpeedUnit.mph
			if (_speedUnit == MuscleCarSpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals MuscleCarSpeedUnit.mph
	...
	} // close public class MuscleCarSpeedometer
