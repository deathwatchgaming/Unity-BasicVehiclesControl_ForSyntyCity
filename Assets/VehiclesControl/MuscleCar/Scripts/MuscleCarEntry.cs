...
namespace VehiclesControl
{
    ...
    {   
        ...
        private void Start() 
        {
            ...
            // GameObject _interfaceTextObject is FindInActiveObjectByName MuscleCar_EntryKey
            GameObject _interfaceTextObject = FindInActiveObjectByName("MuscleCar_EntryKey");
