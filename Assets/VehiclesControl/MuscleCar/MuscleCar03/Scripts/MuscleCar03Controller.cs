...
namespace VehiclesControl
{
	// public enum MuscleCar03SpeedType
	public enum MuscleCar03SpeedType
	{
		mph,
		kmh	

	} // close public enum MuscleCar03SpeedType
	...
	public class MuscleCar03Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// MuscleCar03SpeedType _speedType	
			[SerializeField] private MuscleCar03SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the muscleCar03 car from rolling
