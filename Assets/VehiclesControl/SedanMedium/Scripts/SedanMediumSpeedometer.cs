...
namespace VehiclesControl
{
	...
	public class SedanMediumSpeedometer : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SedanMedium_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SedanMedium_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SedanMedium_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SedanMedium_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SedanMedium_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SedanMedium_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SedanMediumSpeedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SedanMediumSpeedometer");
