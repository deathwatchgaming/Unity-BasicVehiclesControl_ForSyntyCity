/*
 * File: SedanMedium Controller
 * Name: SedanMediumController.cs
...
namespace VehiclesControl
{
	// public enum SedanMediumSpeedType
	public enum SedanMediumSpeedType
	{
		mph,
		kmh	

	} // close public enum SedanMediumSpeedType
	...
	// public class SedanMediumController
	public class SedanMediumController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// SedanMediumSpeedType _speedType	
			[SerializeField] private SedanMediumSpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedanMedium car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SedanMediumSpeedType.mph
			if (_speedType == SedanMediumSpeedType.mph)
			{
			...
			} // close if _speedType equals SedanMediumSpeedType.mph

			// else if _speedType equals SedanMediumSpeedType.kmh
			else if (_speedType == SedanMediumSpeedType.kmh)
			{
			...
			} // close else if _speedType equals SedanMediumSpeedType.kmh

		} // close private void HandleSpeed

	} // close public class SedanMediumController
