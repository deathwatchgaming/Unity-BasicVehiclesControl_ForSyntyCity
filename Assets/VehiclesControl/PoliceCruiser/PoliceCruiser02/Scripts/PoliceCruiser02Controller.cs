/*
 * File: Police Cruiser 02 Controller
 * Name: PoliceCruiser02Controller.cs
...
namespace VehiclesControl
{
	// public enum PoliceCruiser02SpeedType
	public enum PoliceCruiser02SpeedType
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser02SpeedType
	...
	// public class PoliceCruiser02Controller
	public class PoliceCruiser02Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// PoliceCruiser02SpeedType _speedType	
			[SerializeField] private PoliceCruiser02SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals PoliceCruiser02SpeedType.mph
			if (_speedType == PoliceCruiser02SpeedType.mph)
			{
			...
			} // close if _speedType equals PoliceCruiser02SpeedType.mph

			// else if _speedType equals PoliceCruiser02SpeedType.kmh
			else if (_speedType == PoliceCruiser02SpeedType.kmh)
			{
			...
			} // close else if _speedType equals PoliceCruiser02SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class PoliceCruiser02Controller
