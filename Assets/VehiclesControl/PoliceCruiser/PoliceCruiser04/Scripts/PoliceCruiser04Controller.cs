/*
 * File: Police Cruiser 04 Controller
...
namespace VehiclesControl
{
	// public enum PoliceCruiser04SpeedType
	public enum PoliceCruiser04SpeedType
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser04SpeedType
	...
	// public class PoliceCruiser04Controller
	public class PoliceCruiser04Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// PoliceCruiser04SpeedType _speedType	
			[SerializeField] private PoliceCruiser04SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals PoliceCruiser04SpeedType.mph
			if (_speedType == PoliceCruiser04SpeedType.mph)
			{
			...
			} // close if _speedType equals PoliceCruiser04SpeedType.mph

			// else if _speedType equals PoliceCruiser04SpeedType.kmh
			else if (_speedType == PoliceCruiser04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals PoliceCruiser04SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class PoliceCruiser04Controller
