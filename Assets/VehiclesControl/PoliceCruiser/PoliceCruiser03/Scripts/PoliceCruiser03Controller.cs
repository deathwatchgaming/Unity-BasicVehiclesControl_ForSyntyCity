/*
 * File: Police Cruiser 03 Controller
 * Name: PoliceCruiser03Controller.cs
...
namespace VehiclesControl
{
	// public enum PoliceCruiser03SpeedType
	public enum PoliceCruiser03SpeedType
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser03SpeedType
	...
	// public class PoliceCruiser03Controller
	public class PoliceCruiser03Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// PoliceCruiser03SpeedType _speedType	
			[SerializeField] private PoliceCruiser03SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// _rigidbody mass is 2000
			_rigidbody.mass = 2000f;

			// Adjust the center of mass vertically to help prevent the police cruiser from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals PoliceCruiser03SpeedType.mph
			if (_speedType == PoliceCruiser03SpeedType.mph)
			{
			...
			} // close if _speedType equals PoliceCruiser03SpeedType.mph

			// else if _speedType equals PoliceCruiser03SpeedType.kmh
			else if (_speedType == PoliceCruiser03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals PoliceCruiser03SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class PoliceCruiser03Controller
