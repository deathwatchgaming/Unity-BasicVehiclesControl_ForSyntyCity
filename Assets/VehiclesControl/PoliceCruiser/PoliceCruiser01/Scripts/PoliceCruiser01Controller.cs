/*
 * File: Police Cruiser 01 Controller
 * Name: PoliceCruiser01Controller.cs
...
namespace VehiclesControl
{
	// public enum PoliceCruiser01SpeedType
	public enum PoliceCruiser01SpeedType
	{
		mph,
		kmh	

	} // close public enum PoliceCruiser01SpeedType
	...
	// public class PoliceCruiser01Controller
	public class PoliceCruiser01Controller : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// PoliceCruiser01SpeedType _speedType	
			[SerializeField] private PoliceCruiser01SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals PoliceCruiser01SpeedType.mph
			if (_speedType == PoliceCruiser01SpeedType.mph)
			{
			...
			} // close if _speedType equals PoliceCruiser01SpeedType.mph

			// else if _speedType equals PoliceCruiser01SpeedType.kmh
			else if (_speedType == PoliceCruiser01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals PoliceCruiser01SpeedType.kmh

		} // close private void HandleSpeed

	} // close public class PoliceCruiser01Controller
