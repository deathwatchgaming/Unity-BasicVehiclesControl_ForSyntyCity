...
namespace VehiclesControl
{
    ...
    public class PoliceCruiserEntry : MonoBehaviour
    {
        ...
        private void Start() 
        {
            ...
            // GameObject _interfaceTextObject is FindInActiveObjectByName PoliceCruiser_EntryKey
            GameObject _interfaceTextObject = FindInActiveObjectByName("PoliceCruiser_EntryKey");
