/*
 * File: Police Cruiser Controller
 * Name: PoliceCruiserController.cs
...
namespace VehiclesControl
{
	// public enum PoliceCruiserSpeedType
	public enum PoliceCruiserSpeedType
	{
		mph,
		kmh	

	} // close public enum PoliceCruiserSpeedType
	...
	// public class PoliceCruiserController
	public class PoliceCruiserController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// PoliceCruiserSpeedType _speedType	
			[SerializeField] private PoliceCruiserSpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals PoliceCruiserSpeedType.mph
			if (_speedType == PoliceCruiserSpeedType.mph)
			{
			...
			} // close if _speedType equals PoliceCruiserSpeedType.mph

			// else if _speedType equals PoliceCruiserSpeedType.kmh
			else if (_speedType == PoliceCruiserSpeedType.kmh)
			{
			...
			} // close else if _speedType equals PoliceCruiserSpeedType.kmh

		} // close private void HandleSpeed

	} // close public class PoliceCruiserController
